...
fn_((main(S$S_const$u8 args))(E$void) $guard) {
    ...
    var_(rt, GameRuntime) = {
        ...
        .io = try_(io_direct()),
        .ticks = 0,
        .net_clock = time_Awake_evented(&rt.io_loop),
        .net_sched = Sched_coop(&rt.io_loop),
        .net = net_evented(&rt.io_loop),
    };
    ...
    var accept_loop = Sched_async$usize(rt.net_sched, clsr_((sample_acceptLoop)(&rt, &listener)).as_base);
