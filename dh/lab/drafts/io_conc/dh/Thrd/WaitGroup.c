...
$attr($must_check)
$static fn_((Thrd_WaitGroup__spawnInst(Thrd_WaitGroup* self, mem_Alctr gpa, Closure$Void* closure))(Thrd_spawn_E$Thrd));
...
fn_((Thrd_WaitGroup__spawnInst(Thrd_WaitGroup* self, mem_Alctr gpa, Closure$Void* closure))(Thrd_spawn_E$Thrd) $guard) {
