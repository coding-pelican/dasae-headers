...
pp_if_(Thrd_Cond_use_pthread)(
    pp_then_(
        ...
        $static fn_((Thrd_Cond__pthread_timedWait(P$$(Thrd_Cond) self, P$$(Thrd_Mtx) mtx, time_Dur duration))(Thrd_TimeoutE$void));
        $attr($inline_always)
    ...
    pp_else_(
        ...
        $attr($inline_always $must_check)
        $static fn_((Thrd_Cond__common_timedWait(P$$(Thrd_Cond) self, P$$(Thrd_Mtx) mtx, time_Dur duration))(Thrd_TimeoutE$void));
        $attr($inline_always)
...
fn_((Thrd_Cond_timedWait(Thrd_Cond* self, Thrd_Mtx* mtx, time_Dur duration))(Thrd_TimeoutE$void)) {
...
pp_if_(Thrd_Cond_has_specialized)(
    pp_then_(pp_expand(
        pp_switch_ pp_begin(plat_type)(
            pp_case_((plat_type_windows)(
                ...
                $attr($inline_always $must_check)
                $static fn_((Thrd_Cond__windows_impl_wait(P$$(Thrd_Cond) self, P$$(Thrd_Mtx) mtx, O$time_Dur timeout))(Thrd_TimeoutE$void));
                $attr($inline_always)
    ...
    pp_else_(
        ...
        $attr($inline_always $must_check)
        $static fn_((Thrd_Cond__default_impl_wait(P$$(Thrd_Cond) self, P$$(Thrd_Mtx) mtx, O$time_Dur timeout))(Thrd_TimeoutE$void));
        $attr($inline_always)
...
fn_((Thrd_Cond__common_timedWait(Thrd_Cond* self, Thrd_Mtx* mtx, time_Dur duration))(Thrd_TimeoutE$void)) {
...
fn_((Thrd_Cond__windows_impl_wait(Thrd_Cond* self, Thrd_Mtx* mtx, O$time_Dur timeout))(Thrd_TimeoutE$void) $scope) {
