...
$must_check
    ...
    let_(pool, mp_ThrdPool*) = u_castP$((P$$(mp_ThrdPool))(try_(mem_Alctr_create(gpa, typeInfo$(mp_ThrdPool)))));
...
$static fn_((mp_ThrdPool_fini(mp_ThrdPool* self, mem_Alctr gpa))(void)) {
    ...
    mem_Alctr_free(gpa, u_anyS(self->workers));
    mem_Alctr_free(gpa, u_anyS(self->threads));
...
fn_((dh_main(S$S_const$u8 args))(E$void) $guard) {
    ...
    let cpu_count = pri_clamp(expr_(usize $scope) if (1 < args.len) {
    ...
    io_stream_println(u8_l("\nAllocating memory..."));
    let all_components = try_(u_castE$((E$$(S$f32))(mem_Alctr_alloc(gpa, typeInfo$(f32), State_particles * 5))));
    defer_(mem_Alctr_free(gpa, u_anyS(all_components)));
...
fn_((State_initParticles(mp_ThrdPool* pool, Particles particles, m_V2f64 center, m_V2f64 radius_a_b))(void)) {
    mp_parallel_for_pooled(pool, $r(0, State_particles), State_initParticles_worker, u_anyV(l$((State_InitParticlesArgs){
...
fn_((State_clearGrid(mp_ThrdPool* pool, S$Cell grid))(void)) {
    mp_parallel_for_pooled(pool, $r(0, State_grid_width * State_grid_height), State_clearGrid_worker, u_anyV(l$((State_ClearGridArgs){
                                                                                                          .grid = grid,
                                                                                                      })));
}
...
fn_((State_applyGravity(State* self))(void)) {
    mp_parallel_for_pooled(self->pool, $r(0, State_particles), State_applyGravity_worker, u_anyV(l$((State_ApplyGravityArgs){
...
fn_((State_handleCollisions(State* self))(void)) {
    mp_parallel_for_pooled(self->pool, $r(0, State_particles), State_handleCollisions_worker, u_anyV(l$((State_HandleCollisionsArgs){
                                                                                                  .pos_x = self->particles.pos_x,
                                                                                                  .pos_y = self->particles.pos_y,
                                                                                                  .grid = self->grid,
                                                                                              })));
...
fn_((State_updatePositions(State* self))(void)) {
    mp_parallel_for_pooled(self->pool, $r(0, State_particles), State_updatePositions_worker, u_anyV(l$((State_UpdatePositionsArgs){
                                                                                                 .pos_x = self->particles.pos_x,
                                                                                                 .pos_y = self->particles.pos_y,
                                                                                                 .vel_x = self->particles.vel_x,
                                                                                                 .vel_y = self->particles.vel_y,
