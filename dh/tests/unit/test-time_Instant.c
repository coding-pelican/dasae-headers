...
int main(void) {
    ...
    printf("%.4lf %.4lf\n", time_Duration_asSecs_f64(dur_a), time_Duration_asSecs_f64(dur_b));

    time_sleepSecs(3);

    let elapsed = time_Instant_elapsed(base);
    printf("%.4lf\n", time_Duration_asSecs_f64(elapsed));
    let elapsed_1 = time_Instant_elapsed(point_a);
    printf("%.4lf\n", time_Duration_asSecs_f64(elapsed_1));
    let elapsed_2 = time_Instant_elapsed(point_b);
    printf("%.4lf\n", time_Duration_asSecs_f64(elapsed_2));
    return 0;
}
