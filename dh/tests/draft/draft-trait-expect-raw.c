...
$static fn_((Shape_area(Shape self, u_P_const$raw ctx))(f32)) {
    return debug_assert_eqBy(self.type, ctx.type, TypeInfo_eql), self.vt->Shape_area(ctx.raw);
};
$attr($inline_always $maybe_unused)
$static fn_((Shape_perimeter(Shape self, u_P_const$raw ctx))(f32)) {
    return debug_assert_eqBy(self.type, ctx.type, TypeInfo_eql), self.vt->Shape_perimeter(ctx.raw);
};
...
$attr($inline)
$static fn_((Shape_area$Circ(P_const$raw ctx))(f32)) { return Circ_Shape_area(ptrAlignCast$((const Circ*)(ctx))); };
...
$attr($inline)
$static fn_((Shape_perimeter$Circ(P_const$raw ctx))(f32)) { return Circ_Shape_perimeter(ptrAlignCast$((const Circ*)(ctx))); };
...
$static fn_((Shape_dyn$Circ(const Circ* ctx))(ShapeDyn)) {
    return (ShapeDyn){ .trait = Shape_for$Circ(), .ctx = ptrCast$((P_const$raw)(ctx)) };
};
...
$attr($inline)
$static fn_((Shape_area$Rect(P_const$raw ctx))(f32)) { return Rect_Shape_area(ptrAlignCast$((const Rect*)(ctx))); };
...
$attr($inline)
$static fn_((Shape_perimeter$Rect(P_const$raw ctx))(f32)) { return Rect_Shape_perimeter(ptrAlignCast$((const Rect*)(ctx))); };
...
$static fn_((Shape_dyn$Rect(const Rect* ctx))(ShapeDyn)) {
    return (ShapeDyn){ .trait = Shape_for$Rect(), .ctx = ptrCast$((P_const$raw)(ctx)) };
};
...
$static fn_((fmt_display(fmt_Display self, u_P_const$raw ctx, io_Writer writer))(E$void)) {
    return debug_assert_eqBy(self.type, ctx.type, TypeInfo_eql), self.fmt_display(ctx.raw, writer);
};
...
$static fn_((fmt_Display_dyn$Entity(const Entity* ctx))(fmt_DisplayDyn)) {
    return (fmt_DisplayDyn){ .trait = fmt_Display_for$Entity(), .ctx = ptrCast$((P_const$raw)(ctx)) };
};
...
$static fn_((fmt_Display_dyn$Circ(const Circ* ctx))(fmt_DisplayDyn)) {
    return (fmt_DisplayDyn){ .trait = fmt_Display_for$Circ(), .ctx = ptrCast$((P_const$raw)(ctx)) };
};
...
$static fn_((fmt_Display_dyn$Rect(const Rect* ctx))(fmt_DisplayDyn)) {
    return (fmt_DisplayDyn){ .trait = fmt_Display_for$Rect(), .ctx = ptrCast$((P_const$raw)(ctx)) };
};
...
$attr($inline)
$static fn_((fmt_display$ShapeDyn(P_const$raw ctx, io_Writer writer))(E$void)) { return ShapeDyn_fmt_display(ptrAlignCast$((const ShapeDyn*)(ctx)), writer); };
fn_((ShapeDyn_fmt_display(const ShapeDyn* self, io_Writer writer))(E$void) $scope) {
    /* Generated end */
    try_(io_Writer_println(writer, u8_l("Shape {")));
    try_(io_Writer_println(writer, u8_l("    Area: {:.2f}"), self->trait.vt->Shape_area(self->ctx)));
    try_(io_Writer_println(writer, u8_l("    Perimeter: {:.2f}"), self->trait.vt->Shape_perimeter(self->ctx)));
    try_(io_Writer_print(writer, u8_l("}")));
    return_ok({});
} $unscoped(fn);
$attr($inline)
...
$static fn_((fmt_Display_dyn$ShapeDyn(const ShapeDyn* ctx))(fmt_DisplayDyn)) {
    return (fmt_DisplayDyn){ .trait = fmt_Display_for$ShapeDyn(), .ctx = ptrCast$((P_const$raw)(ctx)) };
};
