...
#define mem_startsWith$(_T, /* S_const$T */ _haystack, /* S_const$T */ _prefix... /* O$usize */) tpl_id(mem_startsWith, _T)(_haystack, _prefix)
...
#define mem_endsWith$(_T, /* S_const$T */ _haystack, /* S_const$T */ _suffix... /* O$usize */) tpl_id(mem_endsWith, _T)(_haystack, _suffix)
