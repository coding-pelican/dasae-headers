...
T_use$((E$Void)(Co_Ctx, Co_Rtn, Co_Frame));
co_fn_(sample_feederActor, (P$$(actor_Unit) self; P$$(actor_Unit) dst; S_const$u8 name), E$Void);
co_fn_scope(
    sample_feederActor,
    co_locals_({}),
    co_locals_mut_({
...
co_use_Closure_((sample_feederActor)(P$$(actor_Unit), P$$(actor_Unit), S_const$u8)(E$Void));
...
fn_((main(S$S_const$u8 args))(E$void) $guard) {
    ...
    try_(actor_Unit_start(counter, closure_(sample_counterActor)(counter, u8_l("counter")).as_base));
    ...
    try_(actor_Unit_startE(feeder, closure_(sample_feederActor)(feeder, counter, u8_l("feeder")).as_base));
    defer_({
