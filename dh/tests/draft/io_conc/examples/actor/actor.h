...
$attr($inline_always)
$static fn_((actor_Exit_errorOf(Err reason))(actor_Exit)) {
...
T_decl_E$(actor_Sys);
$attr($must_check)
$extern fn_((actor_Sys_init(exec_Coop* coop, mem_Alctr base_alctr, usize max_units))(E$actor_Sys));
$extern fn_((actor_Sys_fini(actor_Sys* self))(void));
$attr($must_check)
$extern fn_((actor_Sys_createUnit(actor_Sys* self))(E$P$actor_Unit));
...
$attr($must_check)
$extern fn_((actor_Unit_start(actor_Unit* self, Closure$Void* worker))(E$void));
$attr($must_check)
$extern fn_((actor_Unit_startE(actor_Unit* self, Closure$E$Void* worker))(E$void));
$attr($must_check)
$extern fn_((actor_Unit_exit(actor_Unit* self))(O$actor_Exit));
$attr($must_check)
$extern fn_((actor_Unit_send(actor_Unit* self, actor_Msg msg))(E$void));
