// build `clang -o test_mem_info -xc -std=c17 test_mem_info.c ../../src/*.c -static -g  -IC:\dasae-storage\dev\source\c-cpp-workspace\projects\tests\test_terminal\dh\include`
