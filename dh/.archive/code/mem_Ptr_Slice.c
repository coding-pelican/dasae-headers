...
//     if (start >= sl.len_ || end > sl.len_ || start > end) {
//         return Slice_null;
//     }
...
//     usize total_size = sl.len_ * sl.elem_size;
...
//     return Slice_subslice(sl, start, sl.len_);
// }
