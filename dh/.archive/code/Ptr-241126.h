...
#define Ptr_cast(TPtrDest, self)       IMPL_Ptr_cast(TPtrDest, self)
#define Ptr_rawcast(TRawPtrDest, self) IMPL_Ptr_rawcast(TRawPtrDest, self)
...
force_inline anyptr Ptr_rawCastableOrNull(Ptr self, usize required_size);

#define Ptr_castable(self, TPtrDest) IMPL_Ptr_castable(self, TPtrDest)
...
#define IMPL_Ptr_cast(TPtrDest, self) \
    ((TPtrDest)Ptr_raw(self))
...
force_inline anyptr Ptr_rawCastableOrNull(Ptr self, usize required_size) {
    return Ptr_hasMinSize(self, required_size) ? Ptr_raw(self) : null;
}

#define IMPL_Ptr_castable(self, TPtrDest) \
    (Ptr_hasMinSize(self, sizeof(TPtrDest)) && Ptr_align(self) >= Ptr_align(Ptr_cast(TPtrDest, self)))
