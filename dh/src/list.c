...
fn_((ListSgl_Node_removeNext(ListSgl_Node* node))(O$P$ListSgl_Node) $scope) {
    debug_assert_nonnull(node);
...
fn_((ListSgl_Node_reverse(O$P$ListSgl_Node* indirect))(void)) {
    debug_assert_nonnull(indirect);
    if_none(*indirect) {
        return;
    }
    var_(prev, O$P$ListSgl_Node) = none();
    var_(current, O$P$ListSgl_Node) = *indirect;
...
fn_((ListSgl_popFirst(ListSgl* self))(O$P$ListSgl_Node) $scope) {
    debug_assert_nonnull(self);
    if_none(self->first) {
        return_none();
    }
...
fn_((ListDbl_pop(ListDbl* self))(O$P$ListDbl_Node) $scope) {
    debug_assert_nonnull(self);
    if_none(self->last) {
        return_none();
    }
...
fn_((ListDbl_popFirst(ListDbl* self))(O$P$ListDbl_Node) $scope) {
    debug_assert_nonnull(self);
    if_none(self->first) {
        return_none();
    }
