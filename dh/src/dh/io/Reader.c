...
fn_((io_Reader_readAtLeast(io_Reader self, S$u8 out_bytes, usize least_len))(E$usize) $scope) {
...
fn_((io_Reader_skipByte(io_Reader self))(E$void) $scope) {
    return io_Reader_skip(self, 1);
} $unscoped(fn);

fn_((io_Reader_skipAtLeast(io_Reader self, usize least_len))(E$usize) $scope) {
...
fn_((io_Reader_copy(io_Reader self, io_Writer writer))(E$usize) $scope) {
...
fn_((io_Reader_copyByte(io_Reader self, io_Writer writer))(E$void) $scope) {
...
fn_((io_Reader_copyAtLeast(io_Reader self, io_Writer writer, usize least_len))(E$usize) $scope) {
    var_(temp_buf, A$$(1024, u8)) $undefined;
