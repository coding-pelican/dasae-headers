...
fn_((claim_assert_failLog(const char* expr, const char* func, const char* file, u32 line))(void)) {
    io_stream_eprintln(claim_assert__fmt_default, expr, func, file, line);
};

fn_((claim_assert_failLogMsg(const char* expr, const char* func, const char* file, u32 line, const char* msg))(void)) {
...
fn_((claim_assert_failLogFmt(const char* expr, const char* func, const char* file, u32 line, const char* fmt, ...))(void)) {
