...
$static fn_((time_Boot_direct__unsupported_resoln(P$raw ctx))(time_ResolnE$time_Resoln));
pp_if_(plat_is_windows)(pp_then_(
    $static fn_((time_Boot_direct__windows_now(P$raw ctx))(time_Boot_Inst));
    $attr($must_check)
    $static fn_((time_Boot_direct__windows_resoln(P$raw ctx))(time_ResolnE$time_Resoln));
));
pp_if_(plat_based_unix)(pp_then_(
    ...
    $attr($must_check)
    $static fn_((time_Boot_direct__unix_resoln(P$raw ctx))(time_ResolnE$time_Resoln));
));
$attr($must_check)
...
$static let time_Boot_direct__resoln = pp_if_(plat_is_windows)(
    pp_then_(time_Boot_direct__windows_resoln),
    pp_else_(pp_if_(plat_based_unix)(
        pp_then_(time_Boot_direct__unix_resoln),
        pp_else_(time_Boot_direct__unsupported_resoln)
    )));
...
let_(time_Boot_VTbl_noop, time_Boot_VTbl) = {
    ...
    .resolnFn = time_Boot_VTbl_failingResoln,
    ...
    pp_if_(time_Boot_direct_supported)(
        pp_then_({
            ...
            $static let_(vtbl, time_Boot_VTbl) $like_ref = { {
                ...
                .resolnFn = time_Boot_direct__resoln,
...
fn_((time_Boot_resoln(time_Boot self))(time_ResolnE$time_Resoln)) {
    self = time_Boot_ensureValid(self);
...
fn_((time_Boot_VTbl_failingResoln(P$raw ctx))(time_ResolnE$time_Resoln) $scope) {
    let_ignore = ctx;
    return_err(E_cause$time_direct_Unsupported());
} $unscoped(fn);
...
fn_((time_Boot_direct__unsupported_resoln(P$raw ctx))(time_ResolnE$time_Resoln) $scope) {
    let_ignore = ctx;
    return_err(E_cause$time_direct_Unsupported());
} $unscoped(fn);
...
pp_if_(plat_is_windows)(pp_then_(
    ...
    fn_((time_Boot_direct__windows_resoln(P$raw ctx))(time_ResolnE$time_Resoln) $scope) {
        let_ignore = ctx;
...
fn_((time_Boot_direct__unix_resoln(P$raw ctx))(time_ResolnE$time_Resoln) $scope) {
