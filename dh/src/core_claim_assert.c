...
$static let_(claim_assert__fmt_default, const char*) = "Assertion failed: %s, in function %s, at file %s, line %d\n";
$static let_(claim_assert__fmt_msg, const char*) = "Assertion failed: %s\n";
$static let_(claim_assert__fmt_loc, const char*) = "\nin function %s, at file %s, line %d\n";
