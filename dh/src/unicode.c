...
fn_((unicode_utf8ToUTF16Len(S_const$u8 utf8))(unicode_utf8_E$usize) $scope) {
    var_(len16, usize) = 0;
    var_(idx, usize) = 0;
    while (idx < utf8.len) {
...
fn_((unicode_utf8ToUTF16Within(S_const$u8 utf8, S$u16 out))(unicode_utf8_E$S$u16) $scope) {
...
fn_((unicode_utf16ToUTF8Len(S_const$u16 utf16))(unicode_utf16_E$usize) $scope) {
    var_(len8, usize) = 0;
...
$attr($must_check)
$static fn_((unicode__utf16ToUTF8(S_const$u16 utf16, usize required_len, S$u8 out_utf8))(unicode_utf16_E$S$u8) $scope) {
...
fn_((unicode_utf16ToUTF8Within(S_const$u16 utf16, S$u8 out))(unicode_utf16_E$S$u8) $scope) {
...
fn_((unicode_wtf8ToWTF16Within(S_const$u8 wtf8, S$u16 out))(unicode_wtf8_E$S$u16) $scope) {
