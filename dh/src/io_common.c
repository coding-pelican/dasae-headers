...
static $inline_always fn_(io_getStdInHandle(void), posix_fd_t) {
...
static $inline_always fn_(io_getStdOutHandle(void), posix_fd_t) {
    return pp_if_(bti_plat_windows)(
...
static $inline_always fn_(io_getStdErrHandle(void), posix_fd_t) {
    return pp_if_(bti_plat_windows)(
