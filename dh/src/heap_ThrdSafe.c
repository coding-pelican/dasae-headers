...
static fn_((heap_ThrdSafe_alloc(P$raw ctx, usize len, u32 align))(O$P$u8));
static fn_((heap_ThrdSafe_resize(P$raw ctx, S$u8 buf, u32 buf_align, usize new_len))(bool));
static fn_((heap_ThrdSafe_remap(P$raw ctx, S$u8 buf, u32 buf_align, usize new_len))(O$P$u8));
static fn_((heap_ThrdSafe_free(P$raw ctx, S$u8 buf, u32 buf_align))(void));
...
fn_((heap_ThrdSafe_alloc(P$raw ctx, usize len, u32 align))(O$P$u8) $guard) {
...
fn_((heap_ThrdSafe_resize(P$raw ctx, S$u8 buf, u32 buf_align, usize new_len))(bool) $guard) {
    debug_assert_nonnull(ctx);
    let self = as$((heap_ThrdSafe*)(ctx));
    Thrd_Mtx_lock(&self->mutex);
    defer_(Thrd_Mtx_unlock(&self->mutex));
...
fn_((heap_ThrdSafe_remap(P$raw ctx, S$u8 buf, u32 buf_align, usize new_len))(O$P$u8) $guard) {
    debug_assert_nonnull(ctx);
    let self = as$((heap_ThrdSafe*)(ctx));
    Thrd_Mtx_lock(&self->mutex);
    defer_(Thrd_Mtx_unlock(&self->mutex));
...
fn_((heap_ThrdSafe_free(P$raw ctx, S$u8 buf, u32 buf_align))(void) $guard) {
    debug_assert_nonnull(ctx);
    let self = as$((heap_ThrdSafe*)(ctx));
    Thrd_Mtx_lock(&self->mutex);
    defer_(Thrd_Mtx_unlock(&self->mutex));
