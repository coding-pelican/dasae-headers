...
$static let_(debug_assert__fmt_default, S_const$u8) = u8_l("Assertion failed: {:z}, in function {:z}, at file {:z}, line {:d}");
$static let_(debug_assert__fmt_msg, S_const$u8) = u8_l("Assertion failed: {:z}");
$static let_(debug_assert__fmt_expr, S_const$u8) = u8_l("`{:z}`");
$static let_(debug_assert__fmt_loc, S_const$u8) = u8_l("    in function {:z}, at file {:z}, line {:d}");
