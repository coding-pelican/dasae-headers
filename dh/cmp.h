...
force_inline CmpOrdering Cmp(const anyptr lhs, const anyptr rhs, const CmpFn cmp_fn) {
    return cmp_fn(lhs, rhs);
}

// Check if lhs is equal to rhs
force_inline bool Cmp_isEq(const anyptr lhs, const anyptr rhs, const CmpFn cmp_fn) {
    return Cmp(lhs, rhs, cmp_fn) == CmpOrdering_equal;
}

// Check if lhs is not equal to rhs
force_inline bool Cmp_isNe(const anyptr lhs, const anyptr rhs, const CmpFn cmp_fn) {
    return Cmp(lhs, rhs, cmp_fn) != CmpOrdering_equal;
}

// Check if lhs is less than rhs
force_inline bool Cmp_isLt(const anyptr lhs, const anyptr rhs, const CmpFn cmp_fn) {
    return Cmp(lhs, rhs, cmp_fn) == CmpOrdering_less;
}

// Check if lhs is less than or equal to rhs
force_inline bool Cmp_isLe(const anyptr lhs, const anyptr rhs, const CmpFn cmp_fn) {
    return Cmp(lhs, rhs, cmp_fn) != CmpOrdering_greater;
}

// Check if lhs is greater than rhs
force_inline bool Cmp_isGt(const anyptr lhs, const anyptr rhs, const CmpFn cmp_fn) {
    return Cmp(lhs, rhs, cmp_fn) == CmpOrdering_greater;
}

// Check if lhs is greater than or equal to rhs
force_inline bool Cmp_isGe(const anyptr lhs, const anyptr rhs, const CmpFn cmp_fn) {
    return Cmp(lhs, rhs, cmp_fn) != CmpOrdering_less;
}
