...
static fn_((tetris_Console_bootup(void))(E$void) pp_if_(bti_plat_windows)(pp_then_($guard), pp_else_($scope))) {
#if bti_plat_windows
    ...
    return_ok({});
} $un_(pp_if_(bti_plat_windows)(pp_then_(guarded), pp_else_(scoped)))(fn);
