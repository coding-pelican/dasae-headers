...
//             printf("ds_Vec cleanup");
//         });
//         vector_initialized = true;

//         ds_Vec_append(f32, vec, createWith(f32, 1.0f));
//         ds_Vec_append(f32, vec, createWith(f32, 2.0f));
//         ds_Vec_append(f32, vec, createWith(f32, 3.0f));
//         ds_Vec_append(f32, vec, createWith(f32, 4.0f));

//         for (usize i = 0; i < ds_Vec_length(f32, vec); ++i) {
//             debug_assert(ds_Vec_get(f32, vec, i) == (f32)(i + 1.0f));
//             printf("Value at index %zu: %f\n", i, ds_Vec_get(f32, vec, i));
//         }
//     }
...
//         ds_Vec_append(f32, vec, createWith(f32, 5.0f));
//         ds_Vec_append(f32, vec, createWith(f32, 6.0f));
//         ds_Vec_append(f32, vec, createWith(f32, 7.0f));
//         ds_Vec_append(f32, vec, createWith(f32, 8.0f));

//         for (usize i = 0; i < ds_Vec_length(f32, vec); ++i) {
//             debug_assert(ds_Vec_get(f32, vec, i) == (f32)(i + 5.0f));
//             printf("Value at index %zu: %f\n", i, ds_Vec_get(f32, vec, i));
//         }
//     }
