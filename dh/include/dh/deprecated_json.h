...
extern fn_((json_Value_initString(mem_Allocator allocator, S_const$u8 str))(E$json_Value)) $must_check;
extern fn_((json_Value_finiString(json_Value value))(void));
extern fn_((json_Value_initArray(mem_Allocator allocator))(E$json_Value)) $must_check;
extern fn_((json_Value_finiArray(json_Value value))(void));
extern fn_((json_Value_initObject(mem_Allocator allocator))(E$json_Value)) $must_check;
...
extern fn_((json_Value_asBool(json_Value self))(O$bool));
extern fn_((json_Value_asNumber(json_Value self))(O$f64));
extern fn_((json_Value_asString(json_Value self))(O$P$json_Str));
extern fn_((json_Value_asArray(json_Value self))(O$P$json_Arr));
extern fn_((json_Value_asObject(json_Value self))(O$P$json_Obj));

// Validate JSON value structure
extern fn_((json_Value_validate(json_Value self))(E$void)) $must_check;
// Path-based access (e.g., "user.name" or "items[0].id")
extern fn_((json_Value_getPath(json_Value self, S_const$u8 path))(O$P$json_Value));
// Get string representation of JSON type
extern fn_((json_Value_getTypeName(json_Value self))(S_const$u8));
// Check if JSON value equals another
extern fn_((json_Value_eql(json_Value self, json_Value other))(bool));
// Deep copy a JSON value
extern fn_((json_Value_clone(json_Value self, mem_Allocator allocator))(E$json_Value)) $must_check;
...
extern fn_((json_Parser_parse(json_Parser parser))(E$json_Value)) $must_check;
// Parse JSON from the reader
extern fn_((json_Parser_parseWithOpts(json_Parser parser, json_ParseOptions options))(E$json_Value)) $must_check;
...
extern fn_((json_Strfier_strfy(json_Strfier strfier, json_Value value))(E$usize)) $must_check;
// strfy JSON value to writer
extern fn_((json_Strfier_strfyWithOpts(json_Strfier strfier, json_Value value, json_StrfyOptions options))(E$usize)) $must_check;

// String functions
extern fn_((json_Str_init(json_Str* self, mem_Allocator allocator))(E$void)) $must_check;
extern fn_((json_Str_initCap(json_Str* self, usize capacity, mem_Allocator allocator))(E$void)) $must_check;
extern fn_((json_Str_initData(json_Str* self, S_const$u8 str, mem_Allocator allocator))(E$void)) $must_check;
extern fn_((json_Str_fini(json_Str* self, mem_Allocator allocator))(void));
extern fn_((json_Str_append(json_Str* self, json_Str* other, mem_Allocator allocator))(E$void)) $must_check;
extern fn_((json_Str_appendStr(json_Str* self, S_const$u8 str, mem_Allocator allocator))(E$void)) $must_check;
extern fn_((json_Str_eql(const json_Str* self, const json_Str* other))(bool));
extern fn_((json_Str_eqlStr(const json_Str* self, S_const$u8 str))(bool));

// Array operations
// Reserve capacity in array
extern fn_((json_A_reserve(json_Arr* self, usize capacity, mem_Allocator allocator))(E$void)) $must_check;
// Push value to array
extern fn_((json_A_push(json_Arr* self, json_Value value, mem_Allocator allocator))(E$void)) $must_check;
// Pop value from array
extern fn_((json_A_pop(json_Arr* self))(O$P$json_Value));
// Clear array
extern fn_((json_A_clear(json_Arr* self))(void));
// Get value from array by index
extern fn_((json_A_at(const json_Arr* self, usize index))(O$P$json_Value));
// Get array length
extern fn_((json_A_len(const json_Arr* self))(usize));
// Check if array equals another
extern fn_((json_A_eql(const json_Arr* self, const json_Arr* other))(bool));

// Object operations
// Reserve capacity in object
extern fn_((json_Obj_reserve(json_Obj* self, usize capacity, mem_Allocator allocator))(E$void)) $must_check;
// Add key-value pair to object
extern fn_((json_Obj_add(json_Obj* self, S_const$u8 key, json_Value value, mem_Allocator allocator))(E$void)) $must_check;
// Remove key-value pair from object
extern fn_((json_Obj_remove(json_Obj* self, S_const$u8 key))(bool));
// Remove all key-value pairs from object
extern fn_((json_Obj_clear(json_Obj* self, mem_Allocator allocator))(void));
// Check if object has key
extern fn_((json_Obj_has(const json_Obj* self, S_const$u8 key))(bool));
// Set key-value pair in object
extern fn_((json_Obj_set(json_Obj* self, S_const$u8 key, json_Value value))(E$void)) $must_check;
// Get value from object by key
extern fn_((json_Obj_get(const json_Obj* self, S_const$u8 key))(O$P$json_Value));
// Get object size
...
extern fn_((json_A_iter(const json_Arr* self))(json_ArrIter));
extern fn_((json_ArrIter_next(json_ArrIter* self))(O$P$json_Value));
...
extern fn_((json_ObjIter_next(json_ObjIter* self))(O$P$json_ObjEntry));
