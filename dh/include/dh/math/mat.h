...
#define m_M2f32_zero lit$((m_M2f32){ \
    .cols = m_M2f32_of_static( \
        m_V2f32_zero, \
        m_V2f32_zero, \
    ), \
})
#define m_M2f32_identity lit$((m_M2f32){ \
    .cols = m_M2f32_of_static( \
        m_V2f32_unit_x, \
        m_V2f32_unit_y, \
    ), \
...
/* Creation */
#define m_M2f32_of_static(_c0, _c1) lit$((m_M2f32){ \
    .cols = A_init({ \
        (_c0), \
        (_c1), \
    }), \
...
$attr($inline_always)
$static fn_((m_M2f32_of(m_M2f32_ColV c0, m_M2f32_ColV c1))(m_M2f32));
$attr($inline_always)
...
/* Accessors */
$attr($inline_always)
$static fn_((m_M2f32_col(m_M2f32 m, usize idx))(m_V2f32));
$attr($inline_always)
$static fn_((m_M2f32_row(m_M2f32 m, usize idx))(m_V2f32));
...
#define m_M3f32_zero lit$((m_M3f32){ \
    .cols = m_M3f32_of_static( \
        m_V3f32_zero, \
        m_V3f32_zero, \
        m_V3f32_zero, \
    ), \
})
#define m_M3f32_identity lit$((m_M3f32){ \
    .cols = m_M3f32_of_static( \
        m_V3f32_unit_x, \
        m_V3f32_unit_y, \
        m_V3f32_unit_z, \
...
/* Creation */
#define m_M3f32_of_static(_c0, _c1, _c2) lit$((m_M3f32){ \
    .cols = A_init({ \
        (_c0), \
        (_c1), \
        (_c2), \
...
$attr($inline_always)
$static fn_((m_M3f32_of(m_M3f32_ColV c0, m_M3f32_ColV c1, m_M3f32_ColV c2))(m_M3f32));
$attr($inline_always)
...
#define m_M4f32_zero lit$((m_M4f32){ \
    .cols = m_M4f32_of_static( \
        m_V4f32_zero, \
        m_V4f32_zero, \
        m_V4f32_zero, \
    ), \
})
#define m_M4f32_identity lit$((m_M4f32){ \
    .cols = m_M4f32_of_static( \
        m_V4f32_unit_x, \
        m_V4f32_unit_y, \
        m_V4f32_unit_z, \
...
/* Creation */
#define m_M4f32_of_static(_c0, _c1, _c2, _c3) lit$((m_M4f32){ \
    .cols = A_init({ \
        (_c0), \
        (_c1), \
        (_c2), \
...
$attr($inline_always)
$static fn_((m_M4f32_of(m_M4f32_ColV c0, m_M4f32_ColV c1, m_M4f32_ColV c2, m_M4f32_ColV c3))(m_M4f32));
$attr($inline_always)
...
$attr($inline_always)
$static fn_((m_M4f32_perspective(f32 fov_y, f32 aspect, f32 near, f32 far))(m_M4f32));
$attr($inline_always)
$static fn_((m_M4f32_perspectiveInfFar(f32 fov_y, f32 aspect, f32 near))(m_M4f32));
$attr($inline_always)
$static fn_((m_M4f32_ortho(f32 left, f32 right, f32 bottom, f32 top, f32 near, f32 far))(m_M4f32));
$attr($inline_always)
$static fn_((m_M4f32_frustum(f32 left, f32 right, f32 bottom, f32 top, f32 near, f32 far))(m_M4f32));

/*========== M2f32 Implementations ==========================================*/

fn_((m_M2f32_of(m_M2f32_ColV c0, m_M2f32_ColV c1))(m_M2f32)) {
    return lit$((m_M2f32){
        .cols = A_init({
            c0,
            c1,
...
fn_((m_M2f32_row(m_M2f32 m, usize idx))(m_V2f32)) {
    return m_V2f32_of(
        *A_at((A_at((m.cols)[0])->a)[idx]),
        *A_at((A_at((m.cols)[1])->a)[idx])
    );
};

fn_((m_M2f32_transpose(m_M2f32 m))(m_M2f32)) {
    return m_M2f32_of(
        m_V2f32_of(m.s0_0, m.s0_1),
        m_V2f32_of(m.s1_0, m.s1_1)
    );
};
...
fn_((m_M2f32_inv(m_M2f32 m))(m_M2f32)) {
    ...
    return m_M2f32_of(
        m_V2f32_of(m.s1_1 * inv_det, -m.s1_0 * inv_det),
        m_V2f32_of(-m.s0_1 * inv_det, m.s0_0 * inv_det)
    );
};
...
fn_((m_M3f32_of(m_M3f32_ColV c0, m_M3f32_ColV c1, m_M3f32_ColV c2))(m_M3f32)) {
    return lit$((m_M3f32){
        .cols = A_init({ c0, c1, c2 }),
    });
};
fn_((m_M3f32_splat(f32 scalar))(m_M3f32)) {
    let v = m_V3f32_splat(scalar);
    return m_M3f32_of(v, v, v);
};
...
fn_((m_M3f32_mulM(m_M3f32 lhs, m_M3f32 rhs))(m_M3f32)) {
    ...
    for (usize c = 0; c < 3; c++) {
        for (usize r = 0; r < 3; r++) {
            f32 sum = 0.0f;
            for (usize k = 0; k < 3; k++) {
                sum += *A_at((A_at((lhs.cols)[k])->a)[r]) * *A_at((A_at((rhs.cols)[c])->a)[k]);
            }
            *A_at((A_at((result.cols)[c])->a)[r]) = sum;
        }
    }
    return result;
};
...
fn_((m_M3f32_row(m_M3f32 m, usize idx))(m_V3f32)) {
    return m_V3f32_of(
        *A_at((A_at((m.cols)[0])->a)[idx]),
        *A_at((A_at((m.cols)[1])->a)[idx]),
        *A_at((A_at((m.cols)[2])->a)[idx])
    );
};

fn_((m_M3f32_transpose(m_M3f32 m))(m_M3f32)) {
    return m_M3f32_of(
        m_V3f32_of(m.s0_0, m.s0_1, m.s0_2),
        m_V3f32_of(m.s1_0, m.s1_1, m.s1_2),
        m_V3f32_of(m.s2_0, m.s2_1, m.s2_2)
    );
};
...
fn_((m_M3f32_inv(m_M3f32 m))(m_M3f32)) {
    ...
    return m_M3f32_of(
        m_V3f32_of(
            (m.s1_1 * m.s2_2 - m.s1_2 * m.s2_1) * inv_det,
            (m.s1_2 * m.s2_0 - m.s1_0 * m.s2_2) * inv_det,
            (m.s1_0 * m.s2_1 - m.s1_1 * m.s2_0) * inv_det
        ),
        m_V3f32_of(
            (m.s0_2 * m.s2_1 - m.s0_1 * m.s2_2) * inv_det,
            (m.s0_0 * m.s2_2 - m.s0_2 * m.s2_0) * inv_det,
            (m.s0_1 * m.s2_0 - m.s0_0 * m.s2_1) * inv_det
        ),
        m_V3f32_of(
            (m.s0_1 * m.s1_2 - m.s0_2 * m.s1_1) * inv_det,
            (m.s0_2 * m.s1_0 - m.s0_0 * m.s1_2) * inv_det,
            (m.s0_0 * m.s1_1 - m.s0_1 * m.s1_0) * inv_det
        )
    );
};
...
fn_((m_M3f32_translate2D(m_V2f32 t))(m_M3f32)) {
    return m_M3f32_of(
        m_V3f32_of(1.0f, 0.0f, 0.0f),
        m_V3f32_of(0.0f, 1.0f, 0.0f),
        m_V3f32_of(t.x, t.y, 1.0f)
    );
};
...
fn_((m_M4f32_of(m_M4f32_ColV c0, m_M4f32_ColV c1, m_M4f32_ColV c2, m_M4f32_ColV c3))(m_M4f32)) {
    return lit$((m_M4f32){ .cols = A_init({ c0, c1, c2, c3 }) });
};
fn_((m_M4f32_splat(f32 scalar))(m_M4f32)) {
    let v = m_V4f32_splat(scalar);
    return m_M4f32_of(v, v, v, v);
};
...
fn_((m_M4f32_mulM(m_M4f32 lhs, m_M4f32 rhs))(m_M4f32)) {
    ...
    for (usize c = 0; c < 4; c++) {
        for (usize r = 0; r < 4; r++) {
            f32 sum = 0.0f;
            for (usize k = 0; k < 4; k++) {
                sum += A_at((lhs.cols)[k])->s[r] * A_at((rhs.cols)[c])->s[k];
            }
            A_at((result.cols)[c])->s[r] = sum;
        }
    }
    return result;
};
...
fn_((m_M4f32_row(m_M4f32 m, usize idx))(m_V4f32)) {
    return m_V4f32_of(
        ...
        *A_at((A_at((m.cols)[1])->a)[idx]),
        *A_at((A_at((m.cols)[2])->a)[idx]),
        *A_at((A_at((m.cols)[3])->a)[idx])
    );
};

fn_((m_M4f32_transpose(m_M4f32 m))(m_M4f32)) {
    return m_M4f32_of(
        m_V4f32_of(m.s0_0, m.s0_1, m.s0_2, m.s0_3),
        m_V4f32_of(m.s1_0, m.s1_1, m.s1_2, m.s1_3),
        m_V4f32_of(m.s2_0, m.s2_1, m.s2_2, m.s2_3),
        m_V4f32_of(m.s3_0, m.s3_1, m.s3_2, m.s3_3)
    );
};
...
fn_((m_M4f32_lookAt(m_V3f32 eye, m_V3f32 target, m_V3f32 up))(m_M4f32)) {
    ...
    return m_M4f32_of(
        m_V4f32_of(s.x, u.x, -f.x, 0.0f),
        m_V4f32_of(s.y, u.y, -f.y, 0.0f),
        m_V4f32_of(s.z, u.z, -f.z, 0.0f),
        m_V4f32_of(-m_V3f32_dot(s, eye), -m_V3f32_dot(u, eye), m_V3f32_dot(f, eye), 1.0f)
    );
};
fn_((m_M4f32_perspective(f32 fov_y, f32 aspect, f32 near, f32 far))(m_M4f32)) {
    ...
    return m_M4f32_of(
        ...
        m_V4f32_of(0.0f, 0.0f, (far + near) * nf, -1.0f),
        m_V4f32_of(0.0f, 0.0f, 2.0f * far * near * nf, 0.0f)
    );
};
fn_((m_M4f32_perspectiveInfFar(f32 fov_y, f32 aspect, f32 near))(m_M4f32)) {
    let tan_half_fov = flt_tan(fov_y * 0.5f);
    let f = 1.0f / tan_half_fov;
    ...
    return m_M4f32_of(
        m_V4f32_of(f / aspect, 0.0f, 0.0f, 0.0f),
        m_V4f32_of(0.0f, f, 0.0f, 0.0f),
        m_V4f32_of(0.0f, 0.0f, -1.0f, -1.0f),
        m_V4f32_of(0.0f, 0.0f, -2.0f * near, 0.0f)
    );
};
fn_((m_M4f32_ortho(f32 left, f32 right, f32 bottom, f32 top, f32 near, f32 far))(m_M4f32)) {
    let rl = 1.0f / (right - left);
    let tb = 1.0f / (top - bottom);
    let fn_ = 1.0f / (far - near);

    return m_M4f32_of(
        m_V4f32_of(2.0f * rl, 0.0f, 0.0f, 0.0f),
        m_V4f32_of(0.0f, 2.0f * tb, 0.0f, 0.0f),
        m_V4f32_of(0.0f, 0.0f, -2.0f * fn_, 0.0f),
        m_V4f32_of(-(right + left) * rl, -(top + bottom) * tb, -(far + near) * fn_, 1.0f)
    );
};
fn_((m_M4f32_frustum(f32 left, f32 right, f32 bottom, f32 top, f32 near, f32 far))(m_M4f32)) {
    let rl = 1.0f / (right - left);
    let tb = 1.0f / (top - bottom);
    let nf = 1.0f / (near - far);

    return m_M4f32_of(
        m_V4f32_of(2.0f * near * rl, 0.0f, 0.0f, 0.0f),
        m_V4f32_of(0.0f, 2.0f * near * tb, 0.0f, 0.0f),
        m_V4f32_of((right + left) * rl, (top + bottom) * tb, (far + near) * nf, -1.0f),
        m_V4f32_of(0.0f, 0.0f, 2.0f * far * near * nf, 0.0f)
    );
};
