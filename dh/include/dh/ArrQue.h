...
extern fn_((ArrQue_fromBuf(u_S$raw buf))(ArrQue));
...
#define T_use_ArrQue_empty$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_empty, _T)(void))(ArrQue$(_T))) { \
        return type$((ArrQue$(_T))(ArrQue_empty(typeInfo$(_T)))); \
    }
#define T_use_ArrQue_fromBuf$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_fromBuf, _T)(S$(_T) buf))(ArrQue$(_T))) { \
        return type$((ArrQue$(_T))(ArrQue_fromBuf(u_anyS(buf)))); \
    }
#define T_use_ArrQue_init$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrQue_init, _T)(mem_Allocator gpa, usize cap))(E$($set(mem_Err)(ArrQue$(_T)))) $scope) { \
        return_(typeE$((ReturnType)(ArrQue_init(typeInfo$(_T), gpa, cap)))); \
    } $unscoped_(fn)
#define T_use_ArrQue_fini$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_fini, _T)(P$$(ArrQue$(_T)) self, mem_Allocator gpa))(void)) { \
        return ArrQue_fini(self->as_raw, typeInfo$(_T), gpa); \
    }

#define T_use_ArrQue_len$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_len, _T)(ArrQue$(_T) self))(usize)) { \
        return ArrQue_len(*self.as_raw); \
    }
#define T_use_ArrQue_cap$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_cap, _T)(ArrQue$(_T) self))(usize)) { \
        return ArrQue_cap(*self.as_raw); \
    }
#define T_use_ArrQue_head$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_head, _T)(ArrQue$(_T) self))(usize)) { \
        return ArrQue_head(*self.as_raw); \
    }
#define T_use_ArrQue_tail$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_tail, _T)(ArrQue$(_T) self))(usize)) { \
        return ArrQue_tail(*self.as_raw); \
    }
#define T_use_ArrQue_front$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_front, _T)(ArrQue$(_T) self))(O$(P_const$(_T)))) { \
        return u_castO$((O$(P_const$(_T)))(ArrQue_front(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrQue_frontMut$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_frontMut, _T)(ArrQue$(_T) self))(O$(P$(_T)))) { \
        return u_castO$((O$(P$(_T)))(ArrQue_frontMut(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrQue_back$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_back, _T)(ArrQue$(_T) self))(O$(P_const$(_T)))) { \
        return u_castO$((O$(P_const$(_T)))(ArrQue_back(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrQue_backMut$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_backMut, _T)(ArrQue$(_T) self))(O$(P$(_T)))) { \
        return u_castO$((O$(P$(_T)))(ArrQue_backMut(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrQue_at$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_at, _T)(ArrQue$(_T) self, usize idx))(const _T*)) { \
        return u_castP$((const _T*)(ArrQue_at(*self.as_raw, typeInfo$(_T), idx))); \
    }
#define T_use_ArrQue_atMut$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_atMut, _T)(ArrQue$(_T) self, usize idx))(_T*)) { \
        return u_castP$((_T*)(ArrQue_atMut(*self.as_raw, typeInfo$(_T), idx))); \
    }
#define T_use_ArrQue_buf$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_buf, _T)(ArrQue$(_T) self))(S$(const _T))) { \
        return u_castS$((S$(const _T))(ArrQue_buf(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrQue_bufMut$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_bufMut, _T)(ArrQue$(_T) self))(S$(_T))) { \
        return u_castS$((S$(_T))(ArrQue_bufMut(*self.as_raw, typeInfo$(_T)))); \
    }

#define T_use_ArrQue_ensureCap$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrQue_ensureCap, _T)(P$$(ArrQue$(_T)) self, mem_Allocator gpa, usize new_cap))(mem_Err$void)) { \
        return ArrQue_ensureCap(self->as_raw, typeInfo$(_T), gpa, new_cap); \
    }
#define T_use_ArrQue_ensureCapPrecise$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrQue_ensureCapPrecise, _T)(P$$(ArrQue$(_T)) self, mem_Allocator gpa, usize new_cap))(mem_Err$void)) { \
        return ArrQue_ensureCapPrecise(self->as_raw, typeInfo$(_T), gpa, new_cap); \
    }
#define T_use_ArrQue_ensureUnusedCap$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrQue_ensureUnusedCap, _T)(P$$(ArrQue$(_T)) self, mem_Allocator gpa, usize additional))(mem_Err$void)) { \
        return ArrQue_ensureUnusedCap(self->as_raw, typeInfo$(_T), gpa, additional); \
    }
#define T_use_ArrQue_clearRetainingCap$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_clearRetainingCap, _T)(P$$(ArrQue$(_T)) self))(void)) { \
        return ArrQue_clearRetainingCap(self->as_raw); \
    }
#define T_use_ArrQue_clearAndFree$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_clearAndFree, _T)(P$$(ArrQue$(_T)) self, mem_Allocator gpa))(void)) { \
        return ArrQue_clearAndFree(self->as_raw, typeInfo$(_T), gpa); \
    }

#define T_use_ArrQue_enque$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrQue_enque, _T)(P$$(ArrQue$(_T)) self, mem_Allocator gpa, _T item))(mem_Err$void)) { \
        return ArrQue_enque(self->as_raw, gpa, u_anyV(item)); \
    }
#define T_use_ArrQue_enqueFixed$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrQue_enqueFixed, _T)(P$$(ArrQue$(_T)) self, _T item))(mem_Err$void)) { \
        return ArrQue_enqueFixed(self->as_raw, u_anyV(item)); \
    }
#define T_use_ArrQue_enqueWithin$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_enqueWithin, _T)(P$$(ArrQue$(_T)) self, _T item))(void)) { \
        return ArrQue_enqueWithin(self->as_raw, u_anyV(item)); \
    }

#define T_use_ArrQue_deque$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_deque, _T)(P$$(ArrQue$(_T)) self))(O$(_T)) $scope) { \
...
#define T_use_ArrQue_iter$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_iter, _T)(P_const$$(ArrQue$(_T)) self))(ArrQue_Iter$(_T))) { \
        return ArrQue_iter(self->as_raw, typeInfo$(_T)); \
    }
#define T_use_ArrQue_Iter_next$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_Iter_next, _T)(P$$(ArrQue_Iter$(_T)) self))(O$(P_const$(_T)))) { \
        return u_castO$((O$(P_const$(_T)))(ArrQue_Iter_next(self->as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrQue_Iter_nextMut$(_T...) \
    $inline_always $static fn_((tpl_id(ArrQue_Iter_nextMut, _T)(P$$(ArrQue_Iter$(_T)) self))(O$(P$(_T)))) { \
