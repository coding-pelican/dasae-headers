...
$attr($must_check)
$extern fn_((ArrQue_init(TypeInfo type, mem_Alctr gpa, usize cap))(mem_E$ArrQue));
$extern fn_((ArrQue_fini(ArrQue* self, TypeInfo type, mem_Alctr gpa))(void));
...
$attr($must_check)
$extern fn_((ArrQue_ensureCap(ArrQue* self, TypeInfo type, mem_Alctr gpa, usize new_cap))(mem_E$void));
$attr($must_check)
$extern fn_((ArrQue_ensureCapPrecise(ArrQue* self, TypeInfo type, mem_Alctr gpa, usize new_cap))(mem_E$void));
$attr($must_check)
$extern fn_((ArrQue_ensureUnusedCap(ArrQue* self, TypeInfo type, mem_Alctr gpa, usize additional))(mem_E$void));
$extern fn_((ArrQue_clearRetainingCap(ArrQue* self))(void));
$extern fn_((ArrQue_clearAndFree(ArrQue* self, TypeInfo type, mem_Alctr gpa))(void));

$attr($must_check)
$extern fn_((ArrQue_enque(ArrQue* self, mem_Alctr gpa, u_V$raw item))(mem_E$void));
$attr($must_check)
$extern fn_((ArrQue_enqueFixed(ArrQue* self, u_V$raw item))(mem_E$void));
...
#define T_use_ArrQue_empty$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrQue_empty, _T)(void))(ArrQue$(_T))) { \
        return type$((ArrQue$(_T))(ArrQue_empty(typeInfo$(_T)))); \
    }
#define T_use_ArrQue_fixed$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrQue_fixed, _T)(S$(_T) buf))(ArrQue$(_T))) { \
        return type$((ArrQue$(_T))(ArrQue_fixed(u_anyS(buf)))); \
    }
#define T_use_ArrQue_init$(_T...) \
    $attr($inline_always $must_check) \
    $static fn_((tpl$(ArrQue_init, _T)(mem_Alctr gpa, usize cap))(E$($set(mem_E)(ArrQue$(_T)))) $scope) { \
        return_(typeE$((ReturnType)(ArrQue_init(typeInfo$(_T), gpa, cap)))); \
    } $unscoped(fn)
#define T_use_ArrQue_fini$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrQue_fini, _T)(P$$(ArrQue$(_T)) self, mem_Alctr gpa))(void)) { \
...
#define T_use_ArrQue_Grip_release$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrQue_Grip_release, _T)(P$$(ArrQue_Grip$(_T)) self))(void)) { \
...
#define T_use_ArrQue_Iter_next$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrQue_Iter_next, _T)(P$$(ArrQue_Iter$(_T)) self))(O$(P_const$(_T)))) { \
        return u_castO$((O$(P_const$(_T)))(ArrQue_Iter_next(self->as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrQue_Iter_nextMut$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrQue_Iter_nextMut, _T)(P$$(ArrQue_Iter$(_T)) self))(O$(P$(_T)))) { \
