...
#define time_Duration_fromSecs$f32_static(_secs) __comp_fn__time_Duration_fromSecs$f32_static(_secs)
...
$extern fn_((time_Duration_fromSecs$f32(f32 secs))(time_Duration));
...
$extern fn_((time_Duration_asSecs$f32(time_Duration self))(f32));
...
$extern op_fn_mulWith$(((time_Duration, u32)(lhs, rhs))(time_Duration));
$extern op_fn_mulAsgWith$(((time_Duration, u32)(lhs, rhs))(time_Duration*));
$extern op_fn_divWith$(((time_Duration, u32)(lhs, rhs))(time_Duration));
$extern op_fn_divAsgWith$(((time_Duration, u32)(lhs, rhs))(time_Duration*));
...
$extern fn_((time_Duration_mulChkd$u32(time_Duration lhs, u32 rhs))(O$time_Duration));
$extern fn_((time_Duration_divChkd$u32(time_Duration lhs, u32 rhs))(O$time_Duration));
$extern fn_((time_Duration_addSat(time_Duration lhs, time_Duration rhs))(time_Duration));
$extern fn_((time_Duration_subSat(time_Duration lhs, time_Duration rhs))(time_Duration));
$extern fn_((time_Duration_mulSat$u32(time_Duration lhs, u32 rhs))(time_Duration));
