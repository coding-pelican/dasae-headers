...
$extern fn_((time_Inst_freq(void))(time_Inst));
/// Get the inverse of the performance counter frequency.
$extern fn_((time_Inst_freqInv(void))(f64));
/// Get the offset value of the performance counter (relative time).
$extern fn_((time_Inst_offset(void))(time_Inst));
...
$extern fn_((time_Inst_now(void))(time_Inst));
/// Get the elapsed duration from a given time.
$extern fn_((time_Inst_elapsed(time_Inst self))(time_Dur));
...
#define __comp_const__time_Inst_nanos_per_sec \
    (u64_(1, 000, 000, 000ull))
#define __comp_const__time_Inst_intervals_per_sec \
    (u64_(time_Inst_nanos_per_sec / 100))
