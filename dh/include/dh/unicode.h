...
typedef E$$($set(mem_E)(S$u16)) unicode_mem_E$S$u16;
/// Allocates and converts UTF-8 to UTF-16.
$attr($must_check)
$extern fn_((unicode_utf8ToUTF16Alloc(S_const$u8 utf8, mem_Alctr gpa))(unicode_mem_E$S$u16));
...
typedef E$$($set(mem_E)(S$u8)) unicode_mem_E$S$u8;
/// Allocates and converts UTF-16 to UTF-8.
$attr($must_check)
$extern fn_((unicode_utf16ToUTF8Alloc(S_const$u16 utf16, mem_Alctr gpa))(unicode_mem_E$S$u8));
...
$attr($must_check)
$extern fn_((unicode_wtf8ToWTF16Alloc(S_const$u8 wtf8, mem_Alctr gpa))(unicode_mem_E$S$u16));
...
$attr($must_check)
$extern fn_((unicode_wtf16ToWTF8(S_const$u16 wtf16, S$u8 out))(unicode_mem_E$S$u8));
...
$attr($must_check)
$extern fn_((unicode_wtf8ToUTF8LossyAlloc(S_const$u8 wtf8, mem_Alctr gpa))(unicode_mem_E$S$u8));
