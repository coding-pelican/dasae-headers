...
$attr($inline_always)
$static fn_((thrd_Batch_Done_init(thrd_Batch_Id id, TypeInfo result_type, u_V$thrd_Batch_Done$raw ret_mem))(u_V$thrd_Batch_Done$raw));
#define T_use_thrd_Batch_Done_init$(_T...) __gen__T_use_thrd_Batch_Done_init$(_T)
$attr($inline_always)
...
$attr($must_check)
$extern fn_((thrd_Batch_spawn(thrd_Batch* self, TypeInfo result_type, mem_Alctr gpa, Clsr$raw* clsr))(thrd_spawn_E$thrd_Batch_Id));
#define T_use_thrd_Batch_spawn$(_T...) __gen__T_use_thrd_Batch_spawn$(_T)

$attr($must_check)
$extern fn_((thrd_Batch_tryNext(thrd_Batch* self, u_V$thrd_Batch_Done$raw ret_mem))(O$u_V$thrd_Batch_Done$raw));
#define T_use_thrd_Batch_tryNext$(_T...) __gen__T_use_thrd_Batch_tryNext$(_T)
$attr($must_check)
$extern fn_((thrd_Batch_next(thrd_Batch* self, thrd_CancelTok cancel, u_V$thrd_Batch_Done$raw ret_mem))(Sched_Cancelable$O$u_V$thrd_Batch_Done$raw));
#define T_use_thrd_Batch_next$(_T...) __gen__T_use_thrd_Batch_next$(_T)
$attr($must_check)
$extern fn_((thrd_Batch_nextProtcd(thrd_Batch* self, u_V$thrd_Batch_Done$raw ret_mem))(O$u_V$thrd_Batch_Done$raw));
#define T_use_thrd_Batch_nextProtcd$(_T...) __gen__T_use_thrd_Batch_nextProtcd$(_T)
$attr($must_check)
$extern fn_((thrd_Batch_wait(thrd_Batch* self, TypeInfo done_type, thrd_CancelTok cancel))(Sched_Cancelable$void));
#define T_use_thrd_Batch_wait$(_T...) __gen__T_use_thrd_Batch_wait$(_T)
$extern fn_((thrd_Batch_waitProtcd(thrd_Batch* self, TypeInfo done_type))(void));
...
#define __gen__T_use_thrd_Batch_Done_init$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(thrd_Batch_Done_init, _T)(thrd_Batch_Id id))(thrd_Batch_Done$(_T))) { \
        return u_castV$((thrd_Batch_Done$(_T))(thrd_Batch_Done_init(id, typeInfo$(_T), u_asV$((u_V$thrd_Batch_Done$raw)(u_retV$(thrd_Batch_Done$(_T))))))); \
    }
...
#define __gen__T_use_thrd_Batch_init$(_T...) \
    ...
    $static fn_((tpl$(thrd_Batch_init, _T)(S$(thrd_Batch_Done$(_T)) done_buf))(thrd_Batch$(_T))) { \
        return type$((thrd_Batch$(_T))(thrd_Batch_init(u_anyS(done_buf)))); \
    }
#define __gen__T_use_thrd_Batch_fini$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(thrd_Batch_fini, _T)(P$$(thrd_Batch$(_T)) self))(void)) { \
        return thrd_Batch_fini(self->as_raw, typeInfo$(thrd_Batch_Done$(_T))); \
    }
#define __gen__T_use_thrd_Batch_spawn$(_T...) \
    $attr($inline_always $must_check) \
    $static fn_((tpl$(thrd_Batch_spawn, _T)(P$$(thrd_Batch$(_T)) self, mem_Alctr gpa, P$$(Clsr$(_T)) clsr))(thrd_spawn_E$thrd_Batch_Id)) { \
...
#define __gen__T_use_thrd_Batch_tryNext$(_T...) \
    ...
    $static fn_((tpl$(thrd_Batch_tryNext, _T)(P$$(thrd_Batch$(_T)) self))(O$(thrd_Batch_Done$(_T))) $scope) { \
        return_(u_castO$((ReturnType)(thrd_Batch_tryNext(self->as_raw, u_asV$((u_V$thrd_Batch_Done$raw)(u_retV$(thrd_Batch_Done$(_T)))))))); \
    } $unscoped(fn)
#define __gen__T_use_thrd_Batch_next$(_T...) \
    ...
    $static fn_((tpl$(thrd_Batch_next, _T)(P$$(thrd_Batch$(_T)) self, thrd_CancelTok cancel))(E$($set(Sched_Cancelable)(O$(thrd_Batch_Done$(_T))))) $scope) { \
        return_(u_castE$((ReturnType)(thrd_Batch_next(self->as_raw, cancel, u_asV$((u_V$thrd_Batch_Done$raw)(u_retV$(thrd_Batch_Done$(_T)))))))); \
    } $unscoped(fn)
#define __gen__T_use_thrd_Batch_nextProtcd$(_T...) \
    ...
    $static fn_((tpl$(thrd_Batch_nextProtcd, _T)(P$$(thrd_Batch$(_T)) self))(O$(thrd_Batch_Done$(_T))) $scope) { \
        return_(u_castO$((ReturnType)(thrd_Batch_nextProtcd(self->as_raw, u_asV$((u_V$thrd_Batch_Done$raw)(u_retV$(thrd_Batch_Done$(_T)))))))); \
    } $unscoped(fn)
#define __gen__T_use_thrd_Batch_wait$(_T...) \
    ...
    $static fn_((tpl$(thrd_Batch_wait, _T)(P$$(thrd_Batch$(_T)) self, thrd_CancelTok cancel))(Sched_Cancelable$void)) { \
        return thrd_Batch_wait(self->as_raw, typeInfo$(thrd_Batch_Done$(_T)), cancel); \
    }
#define __gen__T_use_thrd_Batch_waitProtcd$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(thrd_Batch_waitProtcd, _T)(P$$(thrd_Batch$(_T)) self))(void)) { \
        return thrd_Batch_waitProtcd(self->as_raw, typeInfo$(thrd_Batch_Done$(_T))); \
    }
/* clang-format on */
...
fn_((thrd_Batch_Done_init(thrd_Batch_Id id, TypeInfo result_type, u_V$thrd_Batch_Done$raw ret_mem))(u_V$thrd_Batch_Done$raw)) {
    claim_assert_nonnull(ret_mem.inner), debug_assert_eqBy(ret_mem.type, thrd_Batch_Done_typeInfo(result_type), TypeInfo_eql);
    ret_mem.inner->id = id;
