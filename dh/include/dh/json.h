...
fn_(json_Value_initNull(void), json_Value);
fn_(json_Value_initBool(bool value), json_Value);
fn_(json_Value_initNumber(f64 value), json_Value);
fn_(json_Value_initString(mem_Allocator allocator, Sli_const$u8 str), Err$json_Value) $must_check;
fn_(json_Value_finiString(json_Value value), void);
fn_(json_Value_initArray(mem_Allocator allocator), Err$json_Value) $must_check;
fn_(json_Value_finiArray(json_Value value), void);
fn_(json_Value_initObject(mem_Allocator allocator), Err$json_Value) $must_check;
fn_(json_Value_finiObject(json_Value value), void);

// Type checking methods
fn_(json_Value_isNull(json_Value self), bool);
fn_(json_Value_isBool(json_Value self), bool);
fn_(json_Value_isNumber(json_Value self), bool);
fn_(json_Value_isString(json_Value self), bool);
fn_(json_Value_isArray(json_Value self), bool);
fn_(json_Value_isObject(json_Value self), bool);

// Type conversion helpers
fn_(json_Value_asBool(json_Value self), Opt$bool);
fn_(json_Value_asNumber(json_Value self), Opt$f64);
fn_(json_Value_asString(json_Value self), Opt$Ptr$json_Str);
fn_(json_Value_asArray(json_Value self), Opt$Ptr$json_Arr);
fn_(json_Value_asObject(json_Value self), Opt$Ptr$json_Obj);

// Validate JSON value structure
fn_(json_Value_validate(json_Value self), Err$void) $must_check;
// Path-based access (e.g., "user.name" or "items[0].id")
fn_(json_Value_getPath(json_Value self, Sli_const$u8 path), Opt$Ptr$json_Value);
...
fn_(json_Value_clone(json_Value self, mem_Allocator allocator), Err$json_Value) $must_check;
// Free a JSON value and all its children
fn_(json_Value_freeAll(json_Value self), void);
...
fn_(json_Parser_parse(json_Parser parser), Err$json_Value) $must_check;
// Parse JSON from the reader
fn_(json_Parser_parseWithOpts(json_Parser parser, json_ParseOptions options), Err$json_Value) $must_check;
...
fn_(json_Strfier_strfy(json_Strfier strfier, json_Value value), Err$usize) $must_check;
// strfy JSON value to writer
fn_(json_Strfier_strfyWithOpts(json_Strfier strfier, json_Value value, json_StrfyOptions options), Err$usize) $must_check;

// String functions
fn_(json_Str_init(json_Str* self, mem_Allocator allocator), Err$void) $must_check;
fn_(json_Str_initCap(json_Str* self, usize capacity, mem_Allocator allocator), Err$void) $must_check;
fn_(json_Str_initData(json_Str* self, Sli_const$u8 str, mem_Allocator allocator), Err$void) $must_check;
fn_(json_Str_fini(json_Str* self, mem_Allocator allocator), void);
fn_(json_Str_append(json_Str* self, json_Str* other, mem_Allocator allocator), Err$void) $must_check;
fn_(json_Str_appendStr(json_Str* self, Sli_const$u8 str, mem_Allocator allocator), Err$void) $must_check;
...
fn_(json_Arr_reserve(json_Arr* self, usize capacity, mem_Allocator allocator), Err$void) $must_check;
// Push value to array
fn_(json_Arr_push(json_Arr* self, json_Value value, mem_Allocator allocator), Err$void) $must_check;
// Pop value from array
fn_(json_Arr_pop(json_Arr* self), Opt$Ptr$json_Value);
// Clear array
fn_(json_Arr_clear(json_Arr* self), void);
// Get value from array by index
fn_(json_Arr_at(const json_Arr* self, usize index), Opt$Ptr$json_Value);
// Get array length
...
fn_(json_Obj_reserve(json_Obj* self, usize capacity, mem_Allocator allocator), Err$void) $must_check;
// Add key-value pair to object
fn_(json_Obj_add(json_Obj* self, Sli_const$u8 key, json_Value value, mem_Allocator allocator), Err$void) $must_check;
...
fn_(json_Obj_set(json_Obj* self, Sli_const$u8 key, json_Value value), Err$void) $must_check;
// Get value from object by key
fn_(json_Obj_get(const json_Obj* self, Sli_const$u8 key), Opt$Ptr$json_Value);
// Get object size
...
fn_(json_ArrIter_next(json_ArrIter* self), Opt$Ptr$json_Value);
...
fn_(json_ObjIter_next(json_ObjIter* self), Opt$Ptr$json_ObjEntry);
