...
// C allocator wrapper functions
Res_Mptr_u8 heap_Classic_alloc(anyptr ctx, usize size, u8 log2_align);
bool        heap_Classic_resize(anyptr ctx, Slice_u8 buf, u8 log2_align, usize new_size);
void        heap_Classic_free(anyptr ctx, Slice_u8 buf, u8 log2_align);
