...
$extern fn_((exec_LaneTimed_init(mem_Alctr gpa))(exec_LaneTimed));
$extern fn_((exec_LaneTimed_fini(exec_LaneTimed* self))(void));

$extern fn_((exec_LaneTimed_nextTimerDeadline(exec_LaneTimed* self))(O$time_Inst));
$extern fn_((exec_LaneTimed_remaining(exec_LaneTimed* self, time_Inst deadline))(time_Dur));
$extern fn_((exec_LaneTimed_wakeDueTimers(exec_LaneTimed* self))(void));
$extern fn_((exec_LaneTimed_runUntil(exec_LaneTimed* self, time_Inst deadline))(void));
