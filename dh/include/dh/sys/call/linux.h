...
typedef enum sys_call_linux_Errno {
    ...
    sys_call_linux_EIO = 5,
    sys_call_linux_E2BIG = 7,
    sys_call_linux_ENOEXEC = 8,
    sys_call_linux_ECHILD = 10,
    sys_call_linux_EAGAIN = 11,
    sys_call_linux_ENOMEM = 12,
    sys_call_linux_EACCES = 13,
    sys_call_linux_ENODEV = 19,
    sys_call_linux_ENOTDIR = 20,
    sys_call_linux_EISDIR = 21,
    sys_call_linux_EINVAL = 22,
    sys_call_linux_ENFILE = 23,
    sys_call_linux_EMFILE = 24,
