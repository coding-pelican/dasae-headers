...
#define T_use_ArrList_empty$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_empty, _T))(ArrList$(_T))) { \
        return type$((ArrList$(_T))(ArrList_empty(typeInfo$(_T)))); \
    }
#define T_use_ArrList_fromBuf$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_fromBuf, _T)(S$(_T) buf))(ArrList$(_T))) { \
...
#define T_use_ArrList_fini$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_fini, _T)(P$$(ArrList$(_T)) self, mem_Allocator gpa))(void)) { \
...
#define T_use_ArrList_expandToCap$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_expandToCap, _T)(P$$(ArrList$(_T)) self))(void)) { \
...
#define T_use_ArrList_shrinkRetainingCap$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_shrinkRetainingCap, _T)(P$$(ArrList$(_T)) self, usize new_len))(void)) { \
        return ArrList_shrinkRetainingCap(self->as_raw, new_len); \
    }
#define T_use_ArrList_shrinkAndFree$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_shrinkAndFree, _T)(P$$(ArrList$(_T)) self, mem_Allocator gpa, usize new_len))(void)) { \
        return ArrList_shrinkAndFree(self->as_raw, typeInfo$(_T), gpa, new_len); \
    }
#define T_use_ArrList_clearRetainingCap$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_clearRetainingCap, _T)(P$$(ArrList$(_T)) self))(void)) { \
        return ArrList_clearRetainingCap(self->as_raw); \
    }
#define T_use_ArrList_clearAndFree$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_clearAndFree, _T)(P$$(ArrList$(_T)) self, mem_Allocator gpa))(void)) { \
...
#define T_use_ArrList_addBackWithin$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_addBackWithin, _T)(P$$(ArrList$(_T)) self))(_T*)) { \
...
#define T_use_ArrList_addBackWithinN$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_addBackWithinN, _T)(P$$(ArrList$(_T)) self, usize n))(S$(_T))) { \
...
#define T_use_ArrList_addAtWithinN$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_addAtWithinN, _T)(P$$(ArrList$(_T)) self, usize idx, usize n))(S$(_T))) { \
...
#define T_use_ArrList_addFrontWithin$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_addFrontWithin, _T)(P$$(ArrList$(_T)) self))(_T*)) { \
...
#define T_use_ArrList_addFrontWithinN$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_addFrontWithinN, _T)(P$$(ArrList$(_T)) self, usize n))(S$(_T))) { \
...
#define T_use_ArrList_appendWithin$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_appendWithin, _T)(P$$(ArrList$(_T)) self, _T item))(void)) { \
...
#define T_use_ArrList_appendWithinN$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_appendWithinN, _T)(P$$(ArrList$(_T)) self, _T item, usize n))(void)) { \
        return ArrList_appendWithinN(self->as_raw, u_anyV(item), n); \
    }
...
#define T_use_ArrList_insertWithin$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_insertWithin, _T)(P$$(ArrList$(_T)) self, usize idx, _T item))(void)) { \
...
#define T_use_ArrList_prependWithin$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_prependWithin, _T)(P$$(ArrList$(_T)) self, _T item))(void)) { \
...
#define T_use_ArrList_prependWithinN$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_prependWithinN, _T)(P$$(ArrList$(_T)) self, _T item, usize n))(void)) { \
        return ArrList_prependWithinN(self->as_raw, u_anyV(item), n); \
    }
...
#define T_use_ArrList_pop$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_pop, _T)(P$$(ArrList$(_T)) self))(O$(_T)) $scope) { \
        return_(u_castO$((ReturnType)(ArrList_pop(self->as_raw, u_retV$(_T))))); \
    } $unscoped_(fn)
#define T_use_ArrList_removeOrd$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_removeOrd, _T)(P$$(ArrList$(_T)) self, usize idx))(_T)) { \
        return u_cast((_T)(ArrList_removeOrd(self->as_raw, idx, u_retV$(_T)))); \
    }
#define T_use_ArrList_removeSwap$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_removeSwap, _T)(P$$(ArrList$(_T)) self, usize idx))(_T)) { \
        return u_cast((_T)(ArrList_removeSwap(self->as_raw, idx, u_retV$(_T)))); \
    }
#define T_use_ArrList_shift$(_T...) \
    $inline_always $static fn_((tpl_id(ArrList_shift, _T)(P$$(ArrList$(_T)) self))(O$(_T)) $scope) { \
