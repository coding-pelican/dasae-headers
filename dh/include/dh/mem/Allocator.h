...
$extern fn_((mem_Allocator_VT_noAlloc(P$raw ctx, usize len, mem_Align align))(O$P$u8));
/// Default VTable functions for no-op fallbacks
$extern fn_((mem_Allocator_VT_noResize(P$raw ctx, S$u8 buf, mem_Align buf_align, usize new_len))(bool));
/// Default VTable functions for no-op fallbacks
$extern fn_((mem_Allocator_VT_noRemap(P$raw ctx, S$u8 buf, mem_Align buf_align, usize new_len))(O$P$u8));
/// Default VTable functions for no-op fallbacks
$extern fn_((mem_Allocator_VT_noFree(P$raw ctx, S$u8 buf, mem_Align buf_align))(void));
...
/// Raw allocation
$extern fn_((mem_Allocator_rawAlloc(mem_Allocator self, usize len, mem_Align align))(O$P$u8));
/// Try to resize in-place
$extern fn_((mem_Allocator_rawResize(mem_Allocator self, S$u8 buf, mem_Align buf_align, usize new_len))(bool));
/// Try to resize, allowing relocation
$extern fn_((mem_Allocator_rawRemap(mem_Allocator self, S$u8 buf, mem_Align buf_align, usize new_len))(O$P$u8));
/// Free mem
$extern fn_((mem_Allocator_rawFree(mem_Allocator self, S$u8 buf, mem_Align buf_align))(void));
...
$extern fn_((mem_Allocator_rawAlloc_debug(mem_Allocator self, usize len, mem_Align align, SrcLoc src_loc))(O$P$u8));
$extern fn_((mem_Allocator_rawResize_debug(mem_Allocator self, S$u8 buf, mem_Align buf_align, usize new_len, SrcLoc src_loc))(bool));
$extern fn_((mem_Allocator_rawRemap_debug(mem_Allocator self, S$u8 buf, mem_Align buf_align, usize new_len, SrcLoc src_loc))(O$P$u8));
$extern fn_((mem_Allocator_rawFree_debug(mem_Allocator self, S$u8 buf, mem_Align buf_align, SrcLoc src_loc))(void));
