...
force_inline fn_(StrCompHash_calculateRaw(const char* raw_str), u32);
...
force_inline fn_(StrCompHash_createRaw(const char* raw_str), StrCompHash);
#endif /* !COMP_TIME */
...
///   // hash now contains the 32-bit hash value for "hello"
force_inline fn_(StrCompHash_calculate(const u8* ptr, usize len), u32);
...
///   // hash.value now contains the hash for "hello"
force_inline fn_(StrCompHash_create(Str_const str), StrCompHash);
...
force_inline fn_(StrCompHash_value(StrCompHash self), u32);
...
///   // hash now contains the 32-bit hash value for "hello"
static_inline fn_(StrCompHash__recur(const u8* ptr, usize len), u32);
...
static_inline fn_(StrCompHash__recur(const u8* ptr, usize len), u32) { /* NOLINT(misc-no-recursion) */
