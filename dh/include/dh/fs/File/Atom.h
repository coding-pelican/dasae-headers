...
$extern fn_((fs_File_Atom_fini(fs_File_Atom* self))(void));
$extern fn_((fs_File_Atom_link(fs_File_Atom* self))(E$void));
$extern fn_((fs_File_Atom_replace(fs_File_Atom* self))(E$void));
