...
T_use$((ArrDeq)(O, E));
T_use_E$($set(mem_E)(ArrDeq));

$extern fn_((ArrDeq_empty(TypeInfo type))(ArrDeq));
$extern fn_((ArrDeq_fixed(u_S$raw buf))(ArrDeq));
$attr($must_check)
$extern fn_((ArrDeq_init(TypeInfo type, mem_Alctr gpa, usize cap))(mem_E$ArrDeq));
$extern fn_((ArrDeq_fini(ArrDeq* self, TypeInfo type, mem_Alctr gpa))(void));
...
$attr($must_check)
$extern fn_((ArrDeq_ensureCap(ArrDeq* self, TypeInfo type, mem_Alctr gpa, usize new_cap))(mem_E$void));
$attr($must_check)
$extern fn_((ArrDeq_ensureCapPrecise(ArrDeq* self, TypeInfo type, mem_Alctr gpa, usize new_cap))(mem_E$void));
$attr($must_check)
$extern fn_((ArrDeq_ensureUnusedCap(ArrDeq* self, TypeInfo type, mem_Alctr gpa, usize additional))(mem_E$void));
$extern fn_((ArrDeq_clearRetainingCap(ArrDeq* self))(void));
$extern fn_((ArrDeq_clearAndFree(ArrDeq* self, TypeInfo type, mem_Alctr gpa))(void));

$attr($must_check)
$extern fn_((ArrDeq_append(ArrDeq* self, mem_Alctr gpa, u_V$raw item))(mem_E$void));
$attr($must_check)
$extern fn_((ArrDeq_appendFixed(ArrDeq* self, u_V$raw item))(mem_E$void));
$extern fn_((ArrDeq_appendWithin(ArrDeq* self, u_V$raw item))(void));

$attr($must_check)
$extern fn_((ArrDeq_prepend(ArrDeq* self, mem_Alctr gpa, u_V$raw item))(mem_E$void));
$attr($must_check)
$extern fn_((ArrDeq_prependFixed(ArrDeq* self, u_V$raw item))(mem_E$void));
...
#define T_use_ArrDeq_empty$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrDeq_empty, _T)(void))(ArrDeq$(_T))) { \
        return type$((ArrDeq$(_T))(ArrDeq_empty(typeInfo$(_T)))); \
    }
#define T_use_ArrDeq_fixed$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrDeq_fixed, _T)(S$(_T) buf))(ArrDeq$(_T))) { \
        return type$((ArrDeq$(_T))(ArrDeq_fixed(u_anyS(buf)))); \
    }
#define T_use_ArrDeq_init$(_T...) \
    $attr($inline_always $must_check) \
    $static fn_((tpl$(ArrDeq_init, _T)(mem_Alctr gpa, usize cap))(E$($set(mem_E)(ArrDeq$(_T)))) $scope) { \
        return_(typeE$((ReturnType)(ArrDeq_init(typeInfo$(_T), gpa, cap)))); \
    } $unscoped(fn)
#define T_use_ArrDeq_fini$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrDeq_fini, _T)(P$$(ArrDeq$(_T)) self, mem_Alctr gpa))(void)) { \
...
#define T_use_ArrDeq_grip$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrDeq_grip, _T)(S$(_T) buf, usize* head, usize* len))(ArrDeq_Grip$(_T))) { \
        return type$((ArrDeq_Grip$(_T))(ArrDeq_grip(u_anyS(buf), head, len))); \
    }
#define T_use_ArrDeq_Grip_release$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrDeq_Grip_release, _T)(P$$(ArrDeq_Grip$(_T)) self))(void)) { \
...
#define T_use_ArrDeq_Iter_next$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrDeq_Iter_next, _T)(P$$(ArrDeq_Iter$(_T)) self))(O$(P_const$(_T)))) { \
        return u_castO$((O$(P_const$(_T)))(ArrDeq_Iter_next(self->as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrDeq_Iter_nextMut$(_T...) \
    $attr($inline_always) \
    $static fn_((tpl$(ArrDeq_Iter_nextMut, _T)(P$$(ArrDeq_Iter$(_T)) self))(O$(P$(_T)))) { \
