...
#define __step__claim_assert_nullS(_Expr, _ExprStr...) __step__claim_assert_msg(((_Expr).ptr == null), _ExprStr " != null", _ExprStr " is nonnull")
#define __step__claim_assert_nonnull(_Expr, _ExprStr...) __step__claim_assert_msg(((_Expr) != null), _ExprStr " == null", _ExprStr " is null")
#define __step__claim_assert_nonnullS(_Expr, _ExprStr...) __step__claim_assert_msg(((_Expr).ptr != null), _ExprStr " == null", _ExprStr " is null")
...
#define __step__claim_assert_nullS_msg(_Expr, _ExprStr, _msg...) __step__claim_assert_msg(((_Expr).ptr == null), _ExprStr " != null", _msg)
#define __step__claim_assert_nonnull_msg(_Expr, _ExprStr, _msg...) __step__claim_assert_msg(((_Expr) != null), _ExprStr " == null", _msg)
#define __step__claim_assert_nonnullS_msg(_Expr, _ExprStr, _msg...) __step__claim_assert_msg(((_Expr).ptr != null), _ExprStr " == null", _msg)
...
#define __step__claim_assert_nullS_fmt(_Expr, _ExprStr, _fmt...) __step__claim_assert_fmt(((_Expr).ptr == null), _ExprStr " != null", _fmt)
#define __step__claim_assert_nonnull_fmt(_Expr, _ExprStr, _fmt...) __step__claim_assert_fmt(((_Expr) != null), _ExprStr " == null", _fmt)
#define __step__claim_assert_nonnullS_fmt(_Expr, _ExprStr, _fmt...) __step__claim_assert_fmt(((_Expr).ptr != null), _ExprStr " == null", _fmt)
