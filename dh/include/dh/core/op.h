...
#define op_add$(_T) tpl_(_T, add)
#define op_sub$(_T) tpl_(_T, sub)
#define op_mul$(_T) tpl_(_T, mul)
#define op_div$(_T) tpl_(_T, div)
#define op_rem$(_T) tpl_(_T, rem)

#define op_addAsg$(_T) tpl_(_T, addAsg)
#define op_subAsg$(_T) tpl_(_T, subAsg)
#define op_mulAsg$(_T) tpl_(_T, mulAsg)
#define op_divAsg$(_T) tpl_(_T, divAsg)
#define op_remAsg$(_T) tpl_(_T, remAsg)

#define op_addWith$(_T, _U) tpl$(tpl_(_T, add), _U)
#define op_subWith$(_T, _U) tpl$(tpl_(_T, sub), _U)
#define op_mulWith$(_T, _U) tpl$(tpl_(_T, mul), _U)
#define op_divWith$(_T, _U) tpl$(tpl_(_T, div), _U)
#define op_remWith$(_T, _U) tpl$(tpl_(_T, rem), _U)

#define op_addAsgWith$(_T, _U) tpl$(tpl_(_T, addAsg), _U)
#define op_subAsgWith$(_T, _U) tpl$(tpl_(_T, subAsg), _U)
#define op_mulAsgWith$(_T, _U) tpl$(tpl_(_T, mulAsg), _U)
#define op_divAsgWith$(_T, _U) tpl$(tpl_(_T, divAsg), _U)
#define op_remAsgWith$(_T, _U) tpl$(tpl_(_T, remAsg), _U)

#define op_neg$(_T) tpl_(_T, neg)
#define op_not$(_T) tpl_(_T, not)

#define op_shl$(_T) tpl_(_T, shl)
#define op_shr$(_T) tpl_(_T, shr)
#define op_and$(_T) tpl_(_T, and)
#define op_xor$(_T) tpl_(_T, xor)
#define op_or$(_T) tpl_(_T, or)

#define op_shlAsg$(_T) tpl_(_T, shlAsg)
#define op_shrAsg$(_T) tpl_(_T, shrAsg)
#define op_andAsg$(_T) tpl_(_T, andAsg)
#define op_xorAsg$(_T) tpl_(_T, xorAsg)
#define op_orAsg$(_T) tpl_(_T, orAsg)

#define op_shlWith$(_T, _U) tpl$(tpl_(_T, shl), _U)
#define op_shrWith$(_T, _U) tpl$(tpl_(_T, shr), _U)
#define op_andWith$(_T, _U) tpl$(tpl_(_T, and), _U)
#define op_xorWith$(_T, _U) tpl$(tpl_(_T, xor), _U)
#define op_orWith$(_T, _U) tpl$(tpl_(_T, or), _U)

#define op_shlAsgWith$(_T, _U) tpl$(tpl_(_T, shlAsg), _U)
#define op_shrAsgWith$(_T, _U) tpl$(tpl_(_T, shrAsg), _U)
#define op_andAsgWith$(_T, _U) tpl$(tpl_(_T, andAsg), _U)
#define op_xorAsgWith$(_T, _U) tpl$(tpl_(_T, xorAsg), _U)
#define op_orAsgWith$(_T, _U) tpl$(tpl_(_T, orAsg), _U)
...
#define __op__fn_binWith$__rename(_ident, _rename, _T, _U, _lhs, _rhs, _TRet...) \
    $inline_always fn_((tpl_(_T, _rename)(_T _lhs, _U _rhs))_TRet) { return pp_cat3(op_, _ident, With$)(_T, _U)(_lhs, _rhs); }
#else /* on_comptime */
#define __op__fn_binWith$__rename(_ident, _rename, _T, _U, _lhs, _rhs, _TRet...) \
    let tpl_(_T, _rename) = pp_cat3(op_, _ident, With$)(_T, _U)
#endif
...
#define __op__fn_binAsgWith$__rename(_ident, _rename, _T, _U, _lhs, _rhs, _TRet...) \
    $inline_always fn_((tpl_(_T, _rename)($P$(_T) _lhs, _U _rhs))_TRet) { return pp_cat3(op_, _ident, AsgWith$)(_T, _U)(_lhs, _rhs); }
#else /* on_comptime */
#define __op__fn_binAsgWith$__rename(_ident, _rename, _T, _U, _lhs, _rhs, _TRet...) \
