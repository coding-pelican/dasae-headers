...
$extern fn_((debug_StackTrace_setupCrashHandler(void))(void));
...
/// @note only available when debug mode is enabled.
/// @note thread-safe (uses thread-safe `io_stream_eprintln`).
$extern fn_((debug_StackTrace_print(void))(void));

#if defined(__cplusplus)
} /* extern "C" */
#endif /* defined(__cplusplus) */
#endif /* core_debug_StackTrace__included */
