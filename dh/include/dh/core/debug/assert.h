...
#define debug_assert(_Expr) \
    __step__debug_assert((_Expr), #_Expr)
#define debug_assert_trap() \
    __step__debug_assert_trap()
#define debug_assert_true(_Expr) \
    __step__debug_assert_true((_Expr), #_Expr)
#define debug_assert_false(_Expr) \
    __step__debug_assert_false((_Expr), #_Expr)
#define debug_assert_eq(_Expr1, _Expr2) \
    __step__debug_assert_eq((_Expr1), (_Expr2), #_Expr1, #_Expr2)
#define debug_assert_ne(_Expr1, _Expr2) \
    __step__debug_assert_ne((_Expr1), (_Expr2), #_Expr1, #_Expr2)
#define debug_assert_null(_Expr) \
    __step__debug_assert_null((_Expr), #_Expr)
#define debug_assert_nonnull(_Expr) \
    __step__debug_assert_nonnull((_Expr), #_Expr)

#define debug_assert_eqBy(_Expr1, _Expr2, _eq) \
    __step__debug_assert_eqBy((_Expr1), (_Expr2), _eq, #_Expr1, #_Expr2)
#define debug_assert_neBy(_Expr1, _Expr2, _ne) \
    __step__debug_assert_neBy((_Expr1), (_Expr2), _ne, #_Expr1, #_Expr2)

#define debug_assert_msg(_Expr, _msg) \
    __step__debug_assert_msg((_Expr), #_Expr, _msg)
#define debug_assert_trap_msg(_msg) \
    __step__debug_assert_trap_msg(_msg)
#define debug_assert_true_msg(_Expr, _msg) \
    __step__debug_assert_true_msg((_Expr), #_Expr, _msg)
#define debug_assert_false_msg(_Expr, _msg) \
    __step__debug_assert_false_msg((_Expr), #_Expr, _msg)
#define debug_assert_eq_msg(_Expr1, _Expr2, _msg) \
    __step__debug_assert_eq_msg((_Expr1), (_Expr2), #_Expr1, #_Expr2, _msg)
#define debug_assert_ne_msg(_Expr1, _Expr2, _msg) \
    __step__debug_assert_ne_msg((_Expr1), (_Expr2), #_Expr1, #_Expr2, _msg)
#define debug_assert_null_msg(_Expr, _msg) \
    __step__debug_assert_null_msg((_Expr), #_Expr, _msg)
#define debug_assert_nonnull_msg(_Expr, _msg) \
    __step__debug_assert_nonnull_msg((_Expr), #_Expr, _msg)

#define debug_assert_fmt(_Expr, _fmt...) \
    __step__debug_assert_fmt((_Expr), #_Expr, _fmt)
#define debug_assert_trap_fmt(_fmt...) \
    __step__debug_assert_trap_fmt(_fmt)
#define debug_assert_true_fmt(_Expr, _fmt...) \
    __step__debug_assert_true_fmt((_Expr), #_Expr, _fmt)
#define debug_assert_false_fmt(_Expr, _fmt...) \
    __step__debug_assert_false_fmt((_Expr), #_Expr, _fmt)
#define debug_assert_eq_fmt(_Expr1, _Expr2, _fmt...) \
    __step__debug_assert_eq_fmt((_Expr1), (_Expr2), #_Expr1, #_Expr2, _fmt)
#define debug_assert_ne_fmt(_Expr1, _Expr2, _fmt...) \
    __step__debug_assert_ne_fmt((_Expr1), (_Expr2), #_Expr1, #_Expr2, _fmt)
#define debug_assert_null_fmt(_Expr, _fmt...) \
    __step__debug_assert_null_fmt((_Expr), #_Expr, _fmt)
#define debug_assert_nonnull_fmt(_Expr, _fmt...) \
    __step__debug_assert_nonnull_fmt((_Expr), #_Expr, _fmt)
...
#define __step__debug_assert(_Expr, _ExprStr...) $ignore_void(\
    (!!_Expr) || (({ \
        static_assert_msg(isCompTimeFoldable(_Expr) ? _Expr : true, _ExprStr); \
...
#define __step__debug_assert_msg(_Expr, _ExprStr, _msg...) $ignore_void( \
    (!!_Expr) || (({ \
        static_assert_msg(isCompTimeFoldable(_Expr) ? _Expr : true, _msg); \
...
#define __step__debug_assert_eq(_Expr1, _Expr2, _Expr1Str, _Expr2Str...) __step__debug_assert_msg(((_Expr1) == (_Expr2)), _Expr1Str " == " _Expr2Str, _Expr1Str " is not equal to " _Expr2Str)
#define __step__debug_assert_ne(_Expr1, _Expr2, _Expr1Str, _Expr2Str...) __step__debug_assert_msg(((_Expr1) != (_Expr2)), _Expr1Str " != " _Expr2Str, _Expr1Str " is equal to " _Expr2Str)
...
#define __step__debug_assert_eqBy(_Expr1, _Expr2, _eq, _Expr1Str, _Expr2Str...) __step__debug_assert_msg((_eq(_Expr1, _Expr2)), _Expr1Str " == " _Expr2Str, _Expr1Str " is not equal to " _Expr2Str)
#define __step__debug_assert_neBy(_Expr1, _Expr2, _ne, _Expr1Str, _Expr2Str...) __step__debug_assert_msg((_ne(_Expr1, _Expr2)), _Expr1Str " != " _Expr2Str, _Expr1Str " is equal to " _Expr2Str)
...
#define __step__debug_assert_eq_msg(_Expr1, _Expr2, _Expr1Str, _Expr2Str, _msg...) __step__debug_assert_msg(((_Expr1) == (_Expr2)), _Expr1Str " == " _Expr2Str, _msg)
#define __step__debug_assert_ne_msg(_Expr1, _Expr2, _Expr1Str, _Expr2Str, _msg...) __step__debug_assert_msg(((_Expr1) != (_Expr2)), _Expr1Str " != " _Expr2Str, _msg)
...
#define __step__debug_assert_eq_fmt(_Expr1, _Expr2, _Expr1Str, _Expr2Str, _fmt...) __step__debug_assert_fmt(((_Expr1) == (_Expr2)), _Expr1Str " == " _Expr2Str, _fmt)
#define __step__debug_assert_ne_fmt(_Expr1, _Expr2, _Expr1Str, _Expr2Str, _fmt...) __step__debug_assert_fmt(((_Expr1) != (_Expr2)), _Expr1Str " != " _Expr2Str, _fmt)
