...
#define __emitNext__for_(_iters, _captures, _block) pp_overload(__emitNext__for, __for__expandIters _iters)(_iters, _captures, _block)
#define __emitNext__for_1(_iters, _captures, _block) __emit__for_1(pp_uniqTok(len), pp_uniqTok(step), (pp_uniqTok(iter_id0)), _iters, _captures, _block)
#define __emitNext__for_2(_iters, _captures, _block) \
    __emit__for_2(pp_uniqTok(len), pp_uniqTok(step), (pp_uniqTok(iter_id0), pp_uniqTok(iter_id1)), _iters, _captures, _block)
#define __emitNext__for_3(_iters, _captures, _block) \
    __emit__for_3(pp_uniqTok(len), pp_uniqTok(step), (pp_uniqTok(iter_id0), pp_uniqTok(iter_id1), pp_uniqTok(iter_id2)), _iters, _captures, _block)
#define __emitNext__for_4(_iters, _captures, _block) \
    __emit__for_4( \
        pp_uniqTok(len), pp_uniqTok(step), (pp_uniqTok(iter_id0), pp_uniqTok(iter_id1), pp_uniqTok(iter_id2), pp_uniqTok(iter_id3)), _iters, _captures, _block \
    )
...
#define __for_2__measureLenNext(__iter_id0, __iter_id1, _iter0, _iter1) prim_min2(__for__lenIter(_iter0)(__iter_id0), __for__lenIter(_iter1)(__iter_id1))
...
#define __for_3__measureLenNext(__iter_id0, __iter_id1, __iter_id2, _iter0, _iter1, _iter2) \
    prim_min3(__for__lenIter(_iter0)(__iter_id0), __for__lenIter(_iter1)(__iter_id1), __for__lenIter(_iter2)(__iter_id2))
...
#define __for_4__measureLenNext(__iter_id0, __iter_id1, __iter_id2, __iter_id3, _iter0, _iter1, _iter2, _iter3) \
    prim_min4(__for__lenIter(_iter0)(__iter_id0), __for__lenIter(_iter1)(__iter_id1), __for__lenIter(_iter2)(__iter_id2), __for__lenIter(_iter3)(__iter_id3))
...
#define __emitNext__for_$_rev(_iters, _captures, _block) pp_overload(__emitNext__for_$_rev, __for__expandIters _iters)(_iters, _captures, _block)
#define __emitNext__for_$_rev_1(_iters, _captures, _block) \
    __emit__for_$_rev_1(pp_uniqTok(len), pp_uniqTok(step), (pp_uniqTok(iter_id0)), _iters, _captures, _block)
#define __emitNext__for_$_rev_2(_iters, _captures, _block) \
    __emit__for_$_rev_2(pp_uniqTok(len), pp_uniqTok(step), (pp_uniqTok(iter_id0), pp_uniqTok(iter_id1)), _iters, _captures, _block)
#define __emitNext__for_$_rev_3(_iters, _captures, _block) \
    __emit__for_$_rev_3(pp_uniqTok(len), pp_uniqTok(step), (pp_uniqTok(iter_id0), pp_uniqTok(iter_id1), pp_uniqTok(iter_id2)), _iters, _captures, _block)
#define __emitNext__for_$_rev_4(_iters, _captures, _block) \
    __emit__for_$_rev_4( \
        pp_uniqTok(len), pp_uniqTok(step), (pp_uniqTok(iter_id0), pp_uniqTok(iter_id1), pp_uniqTok(iter_id2), pp_uniqTok(iter_id3)), _iters, _captures, _block \
    )
