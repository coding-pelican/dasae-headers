...
#define T_use_ArrPQue_empty$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_empty, _T)(u_OrdCtxFn ordFn, u_P_const$raw ord_ctx))(ArrPQue$(_T))) { \
        return type$((ArrPQue$(_T))(ArrPQue_empty(typeInfo$(_T), ordFn, ord_ctx))); \
    }
#define T_use_ArrPQue_fromBuf$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_fromBuf, _T)(S$(_T) buf, u_OrdCtxFn ordFn, u_P_const$raw ord_ctx))(ArrPQue$(_T))) { \
        return type$((ArrPQue$(_T))(ArrPQue_fromBuf(u_anyS(buf), ordFn, ord_ctx))); \
    }
#define T_use_ArrPQue_init$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrPQue_init, _T)(mem_Allocator gpa, usize cap, u_OrdCtxFn ordFn, u_P_const$raw ord_ctx))(E$($set(mem_Err)(ArrPQue$(_T)))) $scope) { \
        return_(typeE$((ReturnType)(ArrPQue_init(typeInfo$(_T), gpa, cap, ordFn, ord_ctx)))); \
    } $unscoped_(fn)
#define T_use_ArrPQue_fini$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_fini, _T)(P$$(ArrPQue$(_T)) self, mem_Allocator gpa))(void)) { \
        return ArrPQue_fini(self->as_raw, typeInfo$(_T), gpa); \
    }

#define T_use_ArrPQue_len$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_len, _T)(ArrPQue$(_T) self))(usize)) { \
        return ArrPQue_len(*self.as_raw); \
    }
#define T_use_ArrPQue_cap$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_cap, _T)(ArrPQue$(_T) self))(usize)) { \
        return ArrPQue_cap(*self.as_raw); \
    }
#define T_use_ArrPQue_peek$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_peek, _T)(ArrPQue$(_T) self))(O$(P_const$(_T)))) { \
        return u_castO$((O$(P_const$(_T)))(ArrPQue_peek(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrPQue_peekMut$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_peekMut, _T)(ArrPQue$(_T) self))(O$(P$(_T)))) { \
        return u_castO$((O$(P$(_T)))(ArrPQue_peekMut(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrPQue_at$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_at, _T)(ArrPQue$(_T) self, usize idx))(const _T*)) { \
        return u_castP$((const _T*)(ArrPQue_at(*self.as_raw, typeInfo$(_T), idx))); \
    }
#define T_use_ArrPQue_atMut$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_atMut, _T)(ArrPQue$(_T) self, usize idx))(_T*)) { \
        return u_castP$((_T*)(ArrPQue_atMut(*self.as_raw, typeInfo$(_T), idx))); \
    }
#define T_use_ArrPQue_items$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_items, _T)(ArrPQue$(_T) self))(S$(const _T))) { \
        return u_castS$((S$(const _T))(ArrPQue_items(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrPQue_itemsMut$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_itemsMut, _T)(ArrPQue$(_T) self))(S$(_T))) { \
        return u_castS$((S$(_T))(ArrPQue_itemsMut(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrPQue_itemsCapped$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_itemsCapped, _T)(ArrPQue$(_T) self))(S$(const _T))) { \
        return u_castS$((S$(const _T))(ArrPQue_itemsCapped(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrPQue_itemsCappedMut$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_itemsCappedMut, _T)(ArrPQue$(_T) self))(S$(_T))) { \
        return u_castS$((S$(_T))(ArrPQue_itemsCappedMut(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrPQue_itemsUnused$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_itemsUnused, _T)(ArrPQue$(_T) self))(S$(const _T))) { \
        return u_castS$((S$(const _T))(ArrPQue_itemsUnused(*self.as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrPQue_itemsUnusedMut$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_itemsUnusedMut, _T)(ArrPQue$(_T) self))(S$(_T))) { \
        return u_castS$((S$(_T))(ArrPQue_itemsUnusedMut(*self.as_raw, typeInfo$(_T)))); \
    }

#define T_use_ArrPQue_ensureCap$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrPQue_ensureCap, _T)(P$$(ArrPQue$(_T)) self, mem_Allocator gpa, usize new_cap))(mem_Err$void)) { \
        return ArrPQue_ensureCap(self->as_raw, typeInfo$(_T), gpa, new_cap); \
    }
#define T_use_ArrPQue_ensureCapPrecise$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrPQue_ensureCapPrecise, _T)(P$$(ArrPQue$(_T)) self, mem_Allocator gpa, usize new_cap))(mem_Err$void)) { \
        return ArrPQue_ensureCapPrecise(self->as_raw, typeInfo$(_T), gpa, new_cap); \
    }
#define T_use_ArrPQue_ensureUnusedCap$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrPQue_ensureUnusedCap, _T)(P$$(ArrPQue$(_T)) self, mem_Allocator gpa, usize additional))(mem_Err$void)) { \
        return ArrPQue_ensureUnusedCap(self->as_raw, typeInfo$(_T), gpa, additional); \
    }
#define T_use_ArrPQue_shrinkRetainingCap$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_shrinkRetainingCap, _T)(P$$(ArrPQue$(_T)) self, usize new_len))(void)) { \
        return ArrPQue_shrinkRetainingCap(self->as_raw, new_len); \
    }
#define T_use_ArrPQue_shrinkAndFree$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_shrinkAndFree, _T)(P$$(ArrPQue$(_T)) self, mem_Allocator gpa, usize new_len))(void)) { \
        return ArrPQue_shrinkAndFree(self->as_raw, typeInfo$(_T), gpa, new_len); \
    }
#define T_use_ArrPQue_clearRetainingCap$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_clearRetainingCap, _T)(P$$(ArrPQue$(_T)) self))(void)) { \
        return ArrPQue_clearRetainingCap(self->as_raw); \
    }
#define T_use_ArrPQue_clearAndFree$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_clearAndFree, _T)(P$$(ArrPQue$(_T)) self, mem_Allocator gpa))(void)) { \
        return ArrPQue_clearAndFree(self->as_raw, typeInfo$(_T), gpa); \
    }

#define T_use_ArrPQue_enque$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrPQue_enque, _T)(P$$(ArrPQue$(_T)) self, mem_Allocator gpa, _T item))(mem_Err$void)) { \
        return ArrPQue_enque(self->as_raw, gpa, u_anyV(item)); \
    }
#define T_use_ArrPQue_enqueFixed$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrPQue_enqueFixed, _T)(P$$(ArrPQue$(_T)) self, _T item))(mem_Err$void)) { \
        return ArrPQue_enqueFixed(self->as_raw, u_anyV(item)); \
    }
#define T_use_ArrPQue_enqueWithin$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_enqueWithin, _T)(P$$(ArrPQue$(_T)) self, _T item))(void)) { \
...
#define T_use_ArrPQue_deque$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_deque, _T)(P$$(ArrPQue$(_T)) self))(O$(_T)) $scope) { \
        return_(u_castO$((ReturnType)(ArrPQue_deque(self->as_raw, u_retV$(_T))))); \
    } $unscoped_(fn)
#define T_use_ArrPQue_removeAt$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_removeAt, _T)(P$$(ArrPQue$(_T)) self, usize idx))(_T)) { \
        return u_cast((_T)(ArrPQue_removeAt(self->as_raw, idx, u_retV$(_T)))); \
    }

#define T_use_ArrPQue_update$(_T...) \
    $must_check \
    $inline_always $static fn_((tpl_id(ArrPQue_update, _T)(P$$(ArrPQue$(_T)) self, _T old_item, _T new_item))(mem_Err$void)) { \
...
#define T_use_ArrPQue_iter$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_iter, _T)(P_const$$(ArrPQue$(_T)) self))(ArrPQue_Iter$(_T))) { \
        return type$((ArrPQue_Iter$(_T))(ArrPQue_iter(self->as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrPQue_Iter_next$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_Iter_next, _T)(P$$(ArrPQue_Iter$(_T)) self))(O$(P_const$(_T)))) { \
        return u_castO$((O$(P_const$(_T)))(ArrPQue_Iter_next(self->as_raw, typeInfo$(_T)))); \
    }
#define T_use_ArrPQue_Iter_nextMut$(_T...) \
    $inline_always $static fn_((tpl_id(ArrPQue_Iter_nextMut, _T)(P$$(ArrPQue_Iter$(_T)) self))(O$(P$(_T)))) { \
