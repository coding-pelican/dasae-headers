...
#define static_assert_trap_msg(_msg) __step__static_assert_trap_msg(_msg)
...
#define __step__static_assert_trap_msg(_msg) static_assert(false, "Failed assertion: " _msg)
...
#define __step__static_assert_trap_msg(_msg) _Static_assert(false, "Failed assertion: " _msg)
#else
...
#define __step__static_assert_trap_msg(_msg) typedef int pp_join(__, __step__static_assert_trap_msg, __COUNTER__)[0]
#else
#define __step__static_assert(_Expr) typedef int pp_join(__, __step__static_assert, __LINE__)[(_Expr) ? 1 : -1]
#define __step__static_assert_msg(_Expr, _msg) typedef int pp_join(__, __step__static_assert_msg, __LINE__)[(_Expr) ? 1 : -1]
#define __step__static_assert_trap() typedef int pp_join(__, __step__static_assert_trap, __LINE__)[0]
#define __step__static_assert_trap_msg(_msg) typedef int pp_join(__, __step__static_assert_trap_msg, __LINE__)[0]
#endif
#endif
