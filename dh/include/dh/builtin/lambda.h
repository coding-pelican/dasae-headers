...
#define la_(/*(_Params...)(_TReturn) <$ext>*/...) pp_expand(pp_defer(block_inline__la_)(param_expand__la_ __VA_ARGS__))
...
/* C++11 */
#define impl_comp_syn__lam_(_Parens_Params, T_Return...) [] _Parens_Params -> T_Return
#elif BUILTIN_COMP_CLANG
/* Needs compile flag `-fblocks -lBlocksRuntime` */
#define impl_comp_syn__lam_(_Parens_Params, T_Return...) ^T_Return _Parens_Params
#elif BUILTIN_COMP_GCC
#define impl_comp_syn__lam_(__lambda, _Parens_Params, T_Return...) T_Return __lambda _Parens_Params
#else  /* others */
/* TODO: Add other compilers */
#endif /* others */
