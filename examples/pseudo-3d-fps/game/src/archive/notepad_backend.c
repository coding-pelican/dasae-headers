...
static HWND NotepadBackend_s_console_window = NULL;

static void NotepadBackend_setNotepadWindow(void) {
    if (!NotepadBackend_s_console_window) {
        NotepadBackend_s_console_window = GetConsoleWindow();
    }
...
static inline u8 getGrayscale(const Color* color) {
