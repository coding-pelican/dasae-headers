...
T_alias$((dage_Viewport_Fit)(enum_((dage_Viewport_Fit $fits($packed))(
...
#define dage_ViewportId_invalid ((dage_ViewportId)u32_limit_max)
...
#endif /* defined(__cplusplus) */
#endif /* dage_render_Viewport__included */
