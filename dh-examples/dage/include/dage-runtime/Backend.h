 ...
 * @details Pure V-Table interface pattern (like mem_Alctr).
...
///          Similar to mem_Alctr design in dh.
...
$attr($must_check)
$extern fn_((dage_Backend_pumpEventsAlloc(dage_Backend self, mem_Alctr gpa, usize cap_hint))(E$dage_Backend_PumpedEvents));
/// @brief Free pumped events
$extern fn_((dage_Backend_PumpedEvents_free(dage_Backend_PumpedEvents* self, mem_Alctr gpa))(void));
...
#endif /* defined(__cplusplus) */
#endif /* dage_runtime_Backend__included */
