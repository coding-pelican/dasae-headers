 ...
 * ## Usage
 * ```c
 * var vt100 = try_(dage_Runtime_VT100_init((dage_Runtime_VT100_Cfg){
 *     .gpa = gpa,
 *     .color_mode = dage_Runtime_VT100_ColorMode_truecolor,
 * }));
...
typedef enum_((dage_Runtime_VT100_ColorMode $fits($packed))(
    dage_Runtime_VT100_ColorMode_mono, /* No color, only brightness */
    dage_Runtime_VT100_ColorMode_16, /* 16 ANSI colors */
    dage_Runtime_VT100_ColorMode_256, /* 256 extended colors */
    dage_Runtime_VT100_ColorMode_truecolor, /* 24-bit RGB */
)) dage_Runtime_VT100_ColorMode;

/*========== Configuration ==========*/

typedef struct dage_Runtime_VT100_Cfg {
    mem_Alctr gpa;
    dage_Runtime_VT100_ColorMode color_mode;
    bool enable_mouse; /* Enable mouse tracking */
    bool use_block_chars; /* Use Unicode block characters for higher resolution */
} dage_Runtime_VT100_Cfg;

/*========== VT100 Instance ==========*/

/// @brief VT100 backend instance
/// @note  Opaque - access only through API functions
typedef struct dage_Runtime_VT100 dage_Runtime_VT100;
T_use_P$(dage_Runtime_VT100);
T_use_E$(P$dage_Runtime_VT100);
...
$attr($must_check)
$extern fn_((dage_Runtime_VT100_init(dage_Runtime_VT100_Cfg cfg))(E$P$dage_Runtime_VT100));
/// @brief Shutdown VT100 backend
/// @details Restores terminal to normal mode
$extern fn_((dage_Runtime_VT100_fini(dage_Runtime_VT100** self))(void));
/// @brief Get dage_Backend interface
$extern fn_((dage_Runtime_VT100_backend(dage_Runtime_VT100* self))(dage_Backend));

#if defined(__cplusplus)
} /* extern "C" */
#endif /* defined(__cplusplus) */
#endif /* dage_Runtime_VT100__included */
