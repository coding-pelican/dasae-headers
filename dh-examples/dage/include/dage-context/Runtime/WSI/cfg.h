...
#define dage_Runtime_WSI__use_x11 \
    /** \
     * @brief Determine which WSI backend to use per platform \
     */ \
    __comp_bool__dage_Runtime_WSI__use_x11
#define __comp_bool__dage_Runtime_WSI__use_x11 pp_expand( \
...
#define dage_Runtime_WSI_max_targets ((usize)8)
#define dage_Runtime_WSI_max_pending_events ((usize)64)
...
typedef struct dage_Runtime_WSI_Image dage_Runtime_WSI_Image;
struct dage_Runtime_WSI_Image pp_switch_((plat_type)(
...
typedef struct dage_Runtime_WSI_Impl dage_Runtime_WSI_Impl;
struct dage_Runtime_WSI_Impl pp_switch_((plat_type)(
    pp_case_((plat_type_windows)({
...
#endif /* defined(__cplusplus) */
#endif /* dage_context_Runtime_WSI_cfg__included */
