#ifndef dage_input_KeyCode__included
#define dage_input_KeyCode__included 1
...
T_alias$((dage_KeyCode)(enum_((dage_KeyCode $fits($packed))(
    dage_KeyCode_unknown = 0xFF,
    ...
    dage_KeyCode$count = dage_KeyCode_unknown
))));
claim_assert_static(eqlType$(dage_KeyCode, u8));
T_use_prl$(dage_KeyCode);

#if defined(__cplusplus)
} /* extern "C" */
#endif /* defined(__cplusplus) */
#endif /* dage_input_KeyCode__included */
