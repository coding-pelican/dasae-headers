...
extern Err$Ptr$engine_UnicodeCanvas engine_UnicodeCanvas_create(mem_Allocator allocator, u32 width, u32 height) must_check;
extern Err$Ptr$engine_UnicodeCanvas engine_UnicodeCanvas_createWithDefault(mem_Allocator allocator, u32 width, u32 height, Color default_color, Sli$u8 default_typo) must_check;
extern void                         engine_UnicodeCanvas_destroy(engine_Canvas* self);
