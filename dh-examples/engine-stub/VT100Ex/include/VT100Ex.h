...
#define engine_stub_VT100Ex_shared_mem_name  L"Local\\EngineVT100ExSharedMem"
...
typedef struct engine_stub_VT100Ex_WindowEvent {
    time_Instant timestamp;
    variant_(()(
        (engine_stub_VT100Ex_WindowEvent_resized, m_V2u32),
        (engine_stub_VT100Ex_WindowEvent_moved, m_V2i32),
        (engine_stub_VT100Ex_WindowEvent_focus_gained, Void),
        (engine_stub_VT100Ex_WindowEvent_focus_lost, Void),
        (engine_stub_VT100Ex_WindowEvent_minimized, Void),
        (engine_stub_VT100Ex_WindowEvent_maximized, Void),
        (engine_stub_VT100Ex_WindowEvent_restored, Void),
        (engine_stub_VT100Ex_WindowEvent_close_requested, Void)
    )) data;
...
typedef struct engine_stub_VT100Ex_SharedState {
    ...
    /* ===== WINDOW EVENTS: Engine → Engine (self, from hooks) ===== */
    struct {
        volatile LONG head;
        volatile LONG tail;
    ...
    /* ===== TERMINAL METRICS: Engine calculates ===== */
    struct {
...
/* Helper functions for lock-free queue operations */
static inline int engine_stub_VT100Ex_InputQueue_push(
    volatile LONG* head,
    volatile LONG* tail,
...
static inline int engine_stub_VT100Ex_InputQueue_pop(
    volatile LONG* head,
    volatile LONG* tail,
    engine_stub_VT100Ex_InputEvent* queue,
