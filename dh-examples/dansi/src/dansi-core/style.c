...
fn_((dansi_style_boldWrite(bool enabled, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_faintWrite(bool enabled, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_italicWrite(bool enabled, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_underlineWrite(bool enabled, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_blinkWrite(bool enabled, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_reverseWrite(bool enabled, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_concealWrite(bool enabled, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_crossedOutWrite(bool enabled, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_resetIntensityWrite(io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_resetItalicWrite(io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_resetUnderlineWrite(io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_resetBlinkWrite(io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_resetReverseWrite(io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_resetConcealWrite(io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_style_resetCrossedOutWrite(io_Writer out))(io_PrintE$void)) {
