...
fn_((dansi_apc_write(S_const$u8 payload, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_apc_writeWithEOS(S_const$u8 payload, dansi_Seq_EOS eos, io_Writer out))(io_PrintE$void) $scope) {
