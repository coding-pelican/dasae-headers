...
fn_((dansi_mode_setRawWrite(u16 mode, bool enabled, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_mode_enableRawWrite(u16 mode, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_mode_disableRawWrite(u16 mode, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_mode_setManyWrite(S_const$u16 modes, bool enabled, io_Writer out))(io_PrintE$void) $scope) {
    ...
    return_ok(try_(io_Writer_writeByte(out, enabled ? dansi_mode_enable_final_byte : dansi_mode_disable_final_byte)));
} $unscoped(fn);
...
fn_((dansi_mode_setWrite(dansi_mode_Code mode, bool enabled, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_mode_enableWrite(dansi_mode_Code mode, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_mode_disableWrite(dansi_mode_Code mode, io_Writer out))(io_PrintE$void)) {
