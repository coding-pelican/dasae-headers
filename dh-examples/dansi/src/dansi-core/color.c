...
fn_((dansi_color_fgWrite(dansi_color_Std color, io_Writer out))(E$void)) {
...
fn_((dansi_color_bgWrite(dansi_color_Std color, io_Writer out))(E$void)) {
...
fn_((dansi_color_resetFGWrite(io_Writer out))(E$void)) {
...
fn_((dansi_color_resetBGWrite(io_Writer out))(E$void)) {
