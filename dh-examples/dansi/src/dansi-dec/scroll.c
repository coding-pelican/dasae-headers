...
fn_((dansi_dec_scroll_setMarginsWrite(u16 top, u16 bottom, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_dec_scroll_resetMarginsWrite(io_Writer out))(io_WriteE$void)) {
