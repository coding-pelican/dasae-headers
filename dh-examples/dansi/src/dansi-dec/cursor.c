...
fn_((dansi_dec_cursor_showWrite(io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_dec_cursor_hideWrite(io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_dec_cursor_saveWrite(io_Writer out))(io_WriteE$void)) {
...
fn_((dansi_dec_cursor_restoreWrite(io_Writer out))(io_WriteE$void)) {
...
fn_((dansi_dec_cursor_setStyleWrite(dansi_dec_cursor_Style style, io_Writer out))(io_PrintE$void)) {
