...
fn_((dansi_xterm_mode_setRawWrite(u16 mode, bool enabled, io_Writer out))(E$void)) {
...
fn_((dansi_xterm_mode_enableRawWrite(u16 mode, io_Writer out))(E$void)) {
...
fn_((dansi_xterm_mode_disableRawWrite(u16 mode, io_Writer out))(E$void)) {
...
fn_((dansi_xterm_mode_setWrite(dansi_xterm_mode_Code mode, bool enabled, io_Writer out))(E$void)) {
...
fn_((dansi_xterm_mode_enableWrite(dansi_xterm_mode_Code mode, io_Writer out))(E$void)) {
...
fn_((dansi_xterm_mode_disableWrite(dansi_xterm_mode_Code mode, io_Writer out))(E$void)) {
...
fn_((dansi_xterm_mode_saveOneWrite(dansi_xterm_mode_Code mode, io_Writer out))(E$void)) {
...
fn_((dansi_xterm_mode_restoreOneWrite(dansi_xterm_mode_Code mode, io_Writer out))(E$void)) {
