...
fn_((dansi_xterm_title_pushWrite(dansi_xterm_title_Target target, io_Writer out))(E$void)) {
    return io_Writer_print(out, u8_l(dansi_csi_make_static("22;{:uhh}", "", "t")), as$(u8)(target));
};
...
fn_((dansi_xterm_title_popWrite(dansi_xterm_title_Target target, io_Writer out))(E$void)) {
    return io_Writer_print(out, u8_l(dansi_csi_make_static("23;{:uhh}", "", "t")), as$(u8)(target));
};
...
fn_((dansi_xterm_title_parseIconLabelReport(
    ...
    return dansi_xterm_title__parseReport(frame, u8_c('L'), dansi_xterm_title_Target_icon);
};
...
fn_((dansi_xterm_title_parseWindowTitleReport(
    ...
    return dansi_xterm_title__parseReport(frame, u8_c('l'), dansi_xterm_title_Target_window);
};
