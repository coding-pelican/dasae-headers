...
$static fn_((dansi_xterm_selection__targetsRaw(dansi_xterm_selection_Targets targets, S$u8 raw))(E$S$u8) $scope) {
    var writing = io_Fixed_Writer_from(io_Fixed_writing(raw));
...
fn_((dansi_xterm_selection_setRawWrite(S_const$u8 targets, S_const$u8 data_base64, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_xterm_selection_queryRawWrite(S_const$u8 targets, io_Writer out))(io_PrintE$void)) {
...
fn_((dansi_xterm_selection_clearRawWrite(S_const$u8 targets, io_Writer out))(io_PrintE$void)) {
