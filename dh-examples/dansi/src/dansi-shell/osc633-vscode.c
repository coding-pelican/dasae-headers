...
$static fn_((dansi_shell_osc633__writeEscapedByte(u8 byte, io_Writer out))(io_WriteE$void) $scope) {
    ...
    return_ok(try_(io_Writer_writeByte(out, *S_at((hex)[byte & dansi_shell_osc633_escape_hex_nibble_mask]))));
} $unscoped(fn);

$static fn_((dansi_shell_osc633__writeEscaped(S_const$u8 bytes, io_Writer out))(io_WriteE$void) $scope) {
    var_(idx, usize) = 0;
    while (idx < bytes.len) {
...
fn_((dansi_shell_osc633_markWrite(dansi_shell_osc633_Mark mark, io_Writer out))(io_PrintE$void) $scope) {
...
fn_((dansi_shell_osc633_commandEndWrite(O$i32 exit_code, io_Writer out))(io_PrintE$void) $scope) {
...
fn_((dansi_shell_osc633_commandLineWrite(S_const$u8 command_line, io_Writer out))(io_PrintE$void) $scope) {
...
fn_((dansi_shell_osc633_commandLineRawWrite(S_const$u8 command_line, io_Writer out))(io_PrintE$void) $scope) {
    try_(io_Writer_writeBytes(out, u8_l(dansi_osc_7bit_prefix dansi_shell_osc633_cmd dansi_osc_cmd_sep dansi_shell_osc633_command_line dansi_osc_cmd_sep)));
...
fn_((dansi_shell_osc633_propertyWrite(dansi_shell_osc633_Prop property, io_Writer out))(io_PrintE$void) $scope) {
...
fn_((dansi_shell_osc633_propertyRawWrite(S_const$u8 property, io_Writer out))(io_PrintE$void) $scope) {
    try_(io_Writer_writeBytes(out, u8_l(dansi_osc_7bit_prefix dansi_shell_osc633_cmd dansi_osc_cmd_sep dansi_shell_osc633_property_op dansi_osc_cmd_sep)));
